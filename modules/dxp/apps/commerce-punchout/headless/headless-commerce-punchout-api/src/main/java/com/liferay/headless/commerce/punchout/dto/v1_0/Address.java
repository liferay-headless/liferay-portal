...
public class Address implements Serializable {
	...
	public Object getValue(String propertyName) {
		if (Objects.equals(propertyName, "city")) {
			return city;
		}
		else if (Objects.equals(propertyName, "city")) {
			return city;
		}
		else if (Objects.equals(propertyName, "country")) {
			return country;
		}
		...
		else if (Objects.equals(propertyName, "region")) {
			return region;
		}
		...
		else if (Objects.equals(propertyName, "typeId")) {
			return typeId;
		}
		else if (Objects.equals(propertyName, "vatNumber")) {
			return vatNumber;
		}
