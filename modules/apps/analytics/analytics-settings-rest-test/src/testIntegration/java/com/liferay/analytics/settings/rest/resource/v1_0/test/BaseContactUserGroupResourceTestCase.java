...
public abstract class BaseContactUserGroupResourceTestCase {
	...
	@Test
	public void testGetContactUserGroupsPageWithSortCollection()
		throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				Method method = contactUserGroup1.getClass(
				).getMethod(
					"get" + StringUtil.upperCaseFirstLetter(entityFieldName)
				);
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(
						contactUserGroup1, entityFieldName, 0L);
					BeanTestUtil.setProperty(
						contactUserGroup2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(
						contactUserGroup1, entityFieldName, 0);
					BeanTestUtil.setProperty(
						contactUserGroup2, entityFieldName, 1);
				}
...
// LIFERAY-REST-BUILDER-HASH:-1543830885