...
public abstract class BaseSiteResourceTestCase {
	...
	@Test
	public void testGetSitesPageWithSortCollection() throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(site1, entityFieldName, 0L);
					BeanTestUtil.setProperty(site2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(site1, entityFieldName, 0);
					BeanTestUtil.setProperty(site2, entityFieldName, 1);
				}
...
// LIFERAY-REST-BUILDER-HASH:331651195