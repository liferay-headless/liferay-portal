...
public abstract class BaseContactAccountGroupResourceTestCase {
	...
	@Test
	public void testGetContactAccountGroupsPageWithSortCollection()
		throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				Method method = contactAccountGroup1.getClass(
				).getMethod(
					"get" + StringUtil.upperCaseFirstLetter(entityFieldName)
				);
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(
						contactAccountGroup1, entityFieldName, 0L);
					BeanTestUtil.setProperty(
						contactAccountGroup2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(
						contactAccountGroup1, entityFieldName, 0);
					BeanTestUtil.setProperty(
						contactAccountGroup2, entityFieldName, 1);
				}
...
// LIFERAY-REST-BUILDER-HASH:-1237922859