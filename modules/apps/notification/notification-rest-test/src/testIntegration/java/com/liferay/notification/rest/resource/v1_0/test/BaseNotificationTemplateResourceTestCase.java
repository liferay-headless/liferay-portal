...
public abstract class BaseNotificationTemplateResourceTestCase {
	...
	@Test
	public void testGetNotificationTemplateMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {
		...
		String endpoint = StringBundler.concat(
			"/notification/v1.0/notification-templates/{notificationTemplateId}".
				replace(
					"{notificationTemplateId}",
					String.valueOf(postNotificationTemplate.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/notification-templates/{notificationTemplateId}".
								replace(
									"{notificationTemplateId}",
									String.valueOf(
										postNotificationTemplate.getId()));
			...
			Assert.assertTrue(
				equals(
					NotificationTemplateSerDes.toDTO(apiResponse),
					NotificationTemplateSerDes.toDTO(vulcanResponse)));
		}
	}
