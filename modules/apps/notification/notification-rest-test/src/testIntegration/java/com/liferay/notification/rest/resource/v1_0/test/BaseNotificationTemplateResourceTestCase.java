...
public abstract class BaseNotificationTemplateResourceTestCase {
	...
	@Test
	public void testGetNotificationTemplatesPageWithSortCollection()
		throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				Method method = notificationTemplate1.getClass(
				).getMethod(
					"get" + StringUtil.upperCaseFirstLetter(entityFieldName)
				);
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(
						notificationTemplate1, entityFieldName, 0L);
					BeanTestUtil.setProperty(
						notificationTemplate2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(
						notificationTemplate1, entityFieldName, 0);
					BeanTestUtil.setProperty(
						notificationTemplate2, entityFieldName, 1);
				}
...
// LIFERAY-REST-BUILDER-HASH:1802109048