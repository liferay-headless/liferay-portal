...
public class ExportImportReportEntryModelImpl
	...
	public static final Object[][] TABLE_COLUMNS = {
		...
		{"entryType", Types.VARCHAR},
		{"exportImportConfigurationId", Types.BIGINT}, {"error", Types.CLOB},
		{"errorStacktrace", Types.CLOB}, {"origin", Types.INTEGER},
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("entryType", Types.VARCHAR);
	...
	private static class AttributeGetterFunctionsHolder {
		...
		static {
			...
			attributeGetterFunctions.put(
				"entryType", ExportImportReportEntry::getEntryType);
			attributeGetterFunctions.put(
	...
	private static class AttributeSetterBiConsumersHolder {
		...
		static {
			...
			attributeSetterBiConsumers.put(
				"entryType",
				(BiConsumer<ExportImportReportEntry, String>)
					ExportImportReportEntry::setEntryType);
			attributeSetterBiConsumers.put(
				"exportImportConfigurationId",
				(BiConsumer<ExportImportReportEntry, Long>)
	...
	public Object clone() {
		...
		exportImportReportEntryImpl.setEntryType(getEntryType());
	...
	public ExportImportReportEntry cloneWithOriginalValues() {
		...
		exportImportReportEntryImpl.setEntryType(
			this.<String>getColumnOriginalValue("entryType"));
		exportImportReportEntryImpl.setExportImportConfigurationId(
			this.<Long>getColumnOriginalValue("exportImportConfigurationId"));
	...
	public CacheModel<ExportImportReportEntry> toCacheModel() {
		...
		exportImportReportEntryCacheModel.entryType = getEntryType();

		String entryType = exportImportReportEntryCacheModel.entryType;

		if ((entryType != null) && (entryType.length() == 0)) {
			exportImportReportEntryCacheModel.entryType = null;
		}
	...
	private void _setColumnOriginalValues() {
		...
		_columnOriginalValues.put("entryType", _entryType);
		_columnOriginalValues.put(
	...
	static {
		...
		columnBitmasks.put("entryType", 512L);

		columnBitmasks.put("exportImportConfigurationId", 1024L);

		columnBitmasks.put("error", 2048L);

		columnBitmasks.put("errorStacktrace", 4096L);
