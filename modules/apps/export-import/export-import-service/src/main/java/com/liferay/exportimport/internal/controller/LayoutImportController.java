	...
	public void importFile(
		...
		try {
			...
			try (ZipReader zipReader = _zipReaderFactory.getZipReader(file)) {
				...
				ExportImportThreadLocal.setPublishingUserName(
					MapUtil.getString(parameterMap, "lastImportUserName"));
				ExportImportThreadLocal.setPublishingUserUuid(
			...
			ExportImportThreadLocal.setPublishingUserName(null);
			ExportImportThreadLocal.setPublishingUserUuid(null);
		}
	}
