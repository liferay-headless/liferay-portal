...
public abstract class BaseReportEntryResourceTestCase {
	...
	@Test
	public void testGetImportProcessReportEntriesPageWithSortCollection()
		throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				Method method = reportEntry1.getClass(
				).getMethod(
					"get" + StringUtil.upperCaseFirstLetter(entityFieldName)
				);
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(reportEntry1, entityFieldName, 0L);
					BeanTestUtil.setProperty(reportEntry2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(reportEntry1, entityFieldName, 0);
					BeanTestUtil.setProperty(reportEntry2, entityFieldName, 1);
				}
...
// LIFERAY-REST-BUILDER-HASH:-938176152