...
public class ExpansionUtil {
	...
	public static String[] getExpansion(
		...
		String toolNameRemainder = toolName.replaceFirst(
			"^(delete|get|head|options|patch|post|put)", StringPool.BLANK);

		String scopePhrase = StringPool.BLANK;

		Map.Entry<String, String> entry = _getEntityScopeEntry(
			toolNameRemainder);
		...
		NounPhrase nounPhrase = _getNounPhrase(entity, toolNameRemainder);
