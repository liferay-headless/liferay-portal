 ...
 */
public class MCPClientHints {

	public static final String BATCH = StringBundler.concat(
	...
	public static final Map<String, String> operations = HashMapBuilder.put(
	...
	public static final Map<String, String> parameters = HashMapBuilder.put(
		"assetLibraryId",
		StringBundler.concat(
