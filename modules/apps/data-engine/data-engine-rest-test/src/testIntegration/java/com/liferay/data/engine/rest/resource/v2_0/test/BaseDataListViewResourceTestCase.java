...
public abstract class BaseDataListViewResourceTestCase {
	...
	@Test
	public void testGetDataListViewMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {

		DataListView postDataListView = testGetDataListView_addDataListView();

		String endpoint = StringBundler.concat(
			"/data-engine/v2.0/data-list-views/{dataListViewId}".replace(
				"{dataListViewId}", String.valueOf(postDataListView.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v2.0/data-list-views/{dataListViewId}".
								replace(
									"{dataListViewId}",
									String.valueOf(postDataListView.getId()));
						}
			...
			Assert.assertTrue(
				equals(
					DataListViewSerDes.toDTO(apiResponse),
					DataListViewSerDes.toDTO(vulcanResponse)));
		}
	}
