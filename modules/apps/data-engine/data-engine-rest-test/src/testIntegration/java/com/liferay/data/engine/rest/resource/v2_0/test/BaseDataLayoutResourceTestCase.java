...
public abstract class BaseDataLayoutResourceTestCase {
	...
	@Test
	public void testGetDataLayoutMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {

		DataLayout postDataLayout = testGetDataLayout_addDataLayout();

		String endpoint = StringBundler.concat(
			"/data-engine/v2.0/data-layouts/{dataLayoutId}".replace(
				"{dataLayoutId}", String.valueOf(postDataLayout.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v2.0/data-layouts/{dataLayoutId}".replace(
								"{dataLayoutId}",
								String.valueOf(postDataLayout.getId()));
						}
			...
			Assert.assertTrue(
				equals(
					DataLayoutSerDes.toDTO(apiResponse),
					DataLayoutSerDes.toDTO(vulcanResponse)));
		}
	}
