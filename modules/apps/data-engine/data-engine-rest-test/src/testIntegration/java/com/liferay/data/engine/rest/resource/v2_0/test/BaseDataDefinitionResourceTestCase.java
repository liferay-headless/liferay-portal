...
public abstract class BaseDataDefinitionResourceTestCase {
	...
	@Test
	public void testGetDataDefinitionMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {
		...
		String endpoint = StringBundler.concat(
			"/data-engine/v2.0/data-definitions/{dataDefinitionId}".replace(
				"{dataDefinitionId}",
				String.valueOf(postDataDefinition.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v2.0/data-definitions/{dataDefinitionId}".
								replace(
									"{dataDefinitionId}",
									String.valueOf(postDataDefinition.getId()));
						}
			...
			Assert.assertTrue(
				equals(
					DataDefinitionSerDes.toDTO(apiResponse),
					DataDefinitionSerDes.toDTO(vulcanResponse)));
		}
	}
