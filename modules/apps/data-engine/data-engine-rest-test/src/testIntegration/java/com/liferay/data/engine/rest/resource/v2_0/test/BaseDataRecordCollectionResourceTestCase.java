...
public abstract class BaseDataRecordCollectionResourceTestCase {
	...
	@Test
	public void testGetDataRecordCollectionMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {
		...
		String endpoint = StringBundler.concat(
			"/data-engine/v2.0/data-record-collections/{dataRecordCollectionId}".
				replace(
					"{dataRecordCollectionId}",
					String.valueOf(postDataRecordCollection.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v2.0/data-record-collections/{dataRecordCollectionId}".
								replace(
									"{dataRecordCollectionId}",
									String.valueOf(
										postDataRecordCollection.getId()));
			...
			Assert.assertTrue(
				equals(
					DataRecordCollectionSerDes.toDTO(apiResponse),
					DataRecordCollectionSerDes.toDTO(vulcanResponse)));
		}
	}
