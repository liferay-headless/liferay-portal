...
public abstract class BaseCTRemoteResourceTestCase {
	...
	@Test
	public void testGetCTRemotesPageWithSortCollection() throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				Method method = ctRemote1.getClass(
				).getMethod(
					"get" + StringUtil.upperCaseFirstLetter(entityFieldName)
				);
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(ctRemote1, entityFieldName, 0L);
					BeanTestUtil.setProperty(ctRemote2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(ctRemote1, entityFieldName, 0);
					BeanTestUtil.setProperty(ctRemote2, entityFieldName, 1);
				}
...
// LIFERAY-REST-BUILDER-HASH:-1736521273