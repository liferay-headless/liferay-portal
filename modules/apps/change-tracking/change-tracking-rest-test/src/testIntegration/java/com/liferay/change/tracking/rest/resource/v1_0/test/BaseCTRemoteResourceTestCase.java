...
public abstract class BaseCTRemoteResourceTestCase {
	...
	@Test
	public void testGetCTRemoteMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {

		CTRemote postCTRemote = testGetCTRemote_addCTRemote();

		String endpoint = StringBundler.concat(
			"/change-tracking-rest/v1.0/ct-remotes/{id}".replace(
				"{ctRemoteId}", String.valueOf(postCTRemote.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/ct-remotes/{id}".replace(
								"{ctRemoteId}",
								String.valueOf(postCTRemote.getId()));
						}
			...
			Assert.assertTrue(
				equals(
					CTRemoteSerDes.toDTO(apiResponse),
					CTRemoteSerDes.toDTO(vulcanResponse)));
		}
	}
