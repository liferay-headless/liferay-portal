...
public abstract class BaseCTProcessResourceTestCase {
	...
	@Test
	public void testGetCTProcessesPageWithSortCollection() throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				Method method = ctProcess1.getClass(
				).getMethod(
					"get" + StringUtil.upperCaseFirstLetter(entityFieldName)
				);
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(ctProcess1, entityFieldName, 0L);
					BeanTestUtil.setProperty(ctProcess2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(ctProcess1, entityFieldName, 0);
					BeanTestUtil.setProperty(ctProcess2, entityFieldName, 1);
				}
...
// LIFERAY-REST-BUILDER-HASH:-410565738