...
public abstract class BaseCTCollectionResourceTestCase {
	...
	@Test
	public void testGetCTCollectionsPageWithSortCollection() throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				Method method = ctCollection1.getClass(
				).getMethod(
					"get" + StringUtil.upperCaseFirstLetter(entityFieldName)
				);
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(
						ctCollection1, entityFieldName, 0L);
					BeanTestUtil.setProperty(
						ctCollection2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(ctCollection1, entityFieldName, 0);
					BeanTestUtil.setProperty(ctCollection2, entityFieldName, 1);
				}
...
// LIFERAY-REST-BUILDER-HASH:390284022