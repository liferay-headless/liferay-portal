...
public class BatchEngineImportTaskExecutorException extends PortalException {
	...
	public static class ItemConversion
		extends BatchEngineImportTaskExecutorException {

		public ItemConversion(Object item, Throwable throwable) {
	...
	private BatchEngineImportTaskExecutorException(String msg) {
		super(msg);
	}

	private BatchEngineImportTaskExecutorException(
