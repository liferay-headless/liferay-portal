...
public abstract class BaseShipmentItemResourceTestCase {
	...
	@Test
	public void testGetShipmentItemMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {

		ShipmentItem postShipmentItem = testGetShipmentItem_addShipmentItem();

		String endpoint = StringBundler.concat(
			"/headless-commerce-admin-shipment/v1.0/shipment-items/{shipmentItemId}".
				replace(
					"{shipmentItemId}",
					String.valueOf(postShipmentItem.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/shipment-items/{shipmentItemId}".
								replace(
									"{shipmentItemId}",
									String.valueOf(postShipmentItem.getId()));
						}
			...
			Assert.assertTrue(
				equals(
					ShipmentItemSerDes.toDTO(apiResponse),
					ShipmentItemSerDes.toDTO(vulcanResponse)));
		}
	}
