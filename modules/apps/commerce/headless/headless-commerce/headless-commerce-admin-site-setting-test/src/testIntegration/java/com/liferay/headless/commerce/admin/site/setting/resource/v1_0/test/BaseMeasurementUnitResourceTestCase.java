...
public abstract class BaseMeasurementUnitResourceTestCase {
	...
	@Test
	public void testGetMeasurementUnitMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {
		...
		String endpoint = StringBundler.concat(
			"/headless-commerce-admin-site-setting/v1.0/measurement-units/{id}".
				replace(
					"{measurementUnitId}",
					String.valueOf(postMeasurementUnit.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/measurement-units/{id}".replace(
								"{measurementUnitId}",
								String.valueOf(postMeasurementUnit.getId()));
						}
			...
			Assert.assertTrue(
				equals(
					MeasurementUnitSerDes.toDTO(apiResponse),
					MeasurementUnitSerDes.toDTO(vulcanResponse)));
		}
	}
