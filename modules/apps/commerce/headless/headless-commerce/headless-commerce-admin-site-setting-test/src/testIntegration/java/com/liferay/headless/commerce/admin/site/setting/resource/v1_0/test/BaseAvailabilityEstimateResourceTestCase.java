...
public abstract class BaseAvailabilityEstimateResourceTestCase {
	...
	@Test
	public void testGetAvailabilityEstimateMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {
		...
		String endpoint = StringBundler.concat(
			"/headless-commerce-admin-site-setting/v1.0/availabilityEstimate/{id}".
				replace(
					"{availabilityEstimateId}",
					String.valueOf(postAvailabilityEstimate.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/availabilityEstimate/{id}".replace(
								"{availabilityEstimateId}",
								String.valueOf(
									postAvailabilityEstimate.getId()));
						}
			...
			Assert.assertTrue(
				equals(
					AvailabilityEstimateSerDes.toDTO(apiResponse),
					AvailabilityEstimateSerDes.toDTO(vulcanResponse)));
		}
	}
