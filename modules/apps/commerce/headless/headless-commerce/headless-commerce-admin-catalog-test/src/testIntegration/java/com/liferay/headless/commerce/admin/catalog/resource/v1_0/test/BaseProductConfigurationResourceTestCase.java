...
public abstract class BaseProductConfigurationResourceTestCase {
	...
	@Test
	public void testGetProductConfigurationMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {
		...
		String endpoint = StringBundler.concat(
			"/headless-commerce-admin-catalog/v1.0/product-configurations/{id}".
				replace(
					"{productConfigurationId}",
					String.valueOf(postProductConfiguration.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/product-configurations/{id}".replace(
								"{productConfigurationId}",
								String.valueOf(
									postProductConfiguration.getId()));
						}
			...
			Assert.assertTrue(
				equals(
					ProductConfigurationSerDes.toDTO(apiResponse),
					ProductConfigurationSerDes.toDTO(vulcanResponse)));
		}
	}
