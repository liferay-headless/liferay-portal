...
public abstract class BaseProductVirtualSettingsFileEntryResourceTestCase {
	...
	@Test
	public void testGetProductVirtualSettingsFileEntryMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {
		...
		String endpoint = StringBundler.concat(
			"/headless-commerce-admin-catalog/v1.0/product-virtual-settings-file-entries/{id}".
				replace(
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/product-virtual-settings-file-entries/{id}".
								replace(
									"{productVirtualSettingsFileEntryId}",
									String.valueOf(
										postProductVirtualSettingsFileEntry.
			...
			Assert.assertTrue(
				equals(
					ProductVirtualSettingsFileEntrySerDes.toDTO(apiResponse),
