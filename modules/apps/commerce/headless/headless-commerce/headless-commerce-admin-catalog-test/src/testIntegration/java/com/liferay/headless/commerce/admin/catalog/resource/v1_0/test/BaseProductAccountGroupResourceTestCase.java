...
public abstract class BaseProductAccountGroupResourceTestCase {
	...
	@Test
	public void testGetProductAccountGroupMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {
		...
		String endpoint = StringBundler.concat(
			"/headless-commerce-admin-catalog/v1.0/product-account-groups/{id}".
				replace(
					"{productAccountGroupId}",
					String.valueOf(postProductAccountGroup.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/product-account-groups/{id}".replace(
								"{productAccountGroupId}",
								String.valueOf(
									postProductAccountGroup.getId()));
						}
			...
			Assert.assertTrue(
				equals(
					ProductAccountGroupSerDes.toDTO(apiResponse),
					ProductAccountGroupSerDes.toDTO(vulcanResponse)));
		}
	}
