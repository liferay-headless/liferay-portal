...
public abstract class BaseProductOptionValueResourceTestCase {
	...
	@Test
	public void testGetProductOptionValueMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {
		...
		String endpoint = StringBundler.concat(
			"/headless-commerce-admin-catalog/v1.0/product-option-values/{id}".
				replace(
					"{productOptionValueId}",
					String.valueOf(postProductOptionValue.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/product-option-values/{id}".replace(
								"{productOptionValueId}",
								String.valueOf(postProductOptionValue.getId()));
						}
			...
			Assert.assertTrue(
				equals(
					ProductOptionValueSerDes.toDTO(apiResponse),
					ProductOptionValueSerDes.toDTO(vulcanResponse)));
		}
	}
