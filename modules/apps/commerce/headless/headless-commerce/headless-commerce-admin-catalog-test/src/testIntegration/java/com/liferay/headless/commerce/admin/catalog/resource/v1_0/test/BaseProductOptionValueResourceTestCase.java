...
public abstract class BaseProductOptionValueResourceTestCase {
	...
	@Test
	public void testGetProductOptionIdProductOptionValuesPageWithSortCollection()
		throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				Method method = productOptionValue1.getClass(
				).getMethod(
					"get" + StringUtil.upperCaseFirstLetter(entityFieldName)
				);
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(
						productOptionValue1, entityFieldName, 0L);
					BeanTestUtil.setProperty(
						productOptionValue2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(
						productOptionValue1, entityFieldName, 0);
					BeanTestUtil.setProperty(
						productOptionValue2, entityFieldName, 1);
				}
...
// LIFERAY-REST-BUILDER-HASH:-1740233723