...
public abstract class BaseSkuVirtualSettingsFileEntryResourceTestCase {
	...
	@Test
	public void testGetSkuVirtualSettingsFileEntryMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {
		...
		String endpoint = StringBundler.concat(
			"/headless-commerce-admin-catalog/v1.0/sku-virtual-settings-file-entries/{id}".
				replace(
					"{skuVirtualSettingsFileEntryId}",
					String.valueOf(postSkuVirtualSettingsFileEntry.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/sku-virtual-settings-file-entries/{id}".
								replace(
									"{skuVirtualSettingsFileEntryId}",
									String.valueOf(
										postSkuVirtualSettingsFileEntry.
											getId()));
						}
			...
			Assert.assertTrue(
				equals(
					SkuVirtualSettingsFileEntrySerDes.toDTO(apiResponse),
					SkuVirtualSettingsFileEntrySerDes.toDTO(vulcanResponse)));
		}
	}
