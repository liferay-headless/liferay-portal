...
public abstract class BaseProductConfigurationListResourceTestCase {
	...
	@Test
	public void testGetProductConfigurationListsPageWithSortCollection()
		throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				Method method = productConfigurationList1.getClass(
				).getMethod(
					"get" + StringUtil.upperCaseFirstLetter(entityFieldName)
				);
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(
						productConfigurationList1, entityFieldName, 0L);
					BeanTestUtil.setProperty(
						productConfigurationList2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(
						productConfigurationList1, entityFieldName, 0);
					BeanTestUtil.setProperty(
						productConfigurationList2, entityFieldName, 1);
				}
...
// LIFERAY-REST-BUILDER-HASH:-2111073712