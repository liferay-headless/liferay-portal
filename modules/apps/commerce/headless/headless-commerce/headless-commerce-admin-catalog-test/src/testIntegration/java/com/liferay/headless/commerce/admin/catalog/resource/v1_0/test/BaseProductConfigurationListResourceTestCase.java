...
public abstract class BaseProductConfigurationListResourceTestCase {
	...
	@Test
	public void testGetProductConfigurationListMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {
		...
		String endpoint = StringBundler.concat(
			"/headless-commerce-admin-catalog/v1.0/product-configuration-lists/{id}".
				replace(
					"{productConfigurationListId}",
					String.valueOf(postProductConfigurationList.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/product-configuration-lists/{id}".
								replace(
									"{productConfigurationListId}",
									String.valueOf(
										postProductConfigurationList.getId()));
			...
			Assert.assertTrue(
				equals(
					ProductConfigurationListSerDes.toDTO(apiResponse),
					ProductConfigurationListSerDes.toDTO(vulcanResponse)));
		}
	}
