...
public abstract class BaseProductOptionResourceTestCase {
	...
	@Test
	public void testGetProductOptionMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {
		...
		String endpoint = StringBundler.concat(
			"/headless-commerce-admin-catalog/v1.0/productOptions/{id}".replace(
				"{productOptionId}",
				String.valueOf(postProductOption.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/productOptions/{id}".replace(
								"{productOptionId}",
								String.valueOf(postProductOption.getId()));
						}
			...
			Assert.assertTrue(
				equals(
					ProductOptionSerDes.toDTO(apiResponse),
					ProductOptionSerDes.toDTO(vulcanResponse)));
		}
	}
