...
public abstract class BaseProductOptionResourceTestCase {
	...
	@Test
	public void testGetProductByExternalReferenceCodeProductOptionsPageWithSortCollection()
		throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				Method method = productOption1.getClass(
				).getMethod(
					"get" + StringUtil.upperCaseFirstLetter(entityFieldName)
				);
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(
						productOption1, entityFieldName, 0L);
					BeanTestUtil.setProperty(
						productOption2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(
						productOption1, entityFieldName, 0);
					BeanTestUtil.setProperty(
						productOption2, entityFieldName, 1);
				}
	...
	@Test
	public void testGetProductIdProductOptionsPageWithSortCollection()
		throws Exception {
...
// LIFERAY-REST-BUILDER-HASH:452764763