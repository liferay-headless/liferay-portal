...
public abstract class BasePinResourceTestCase {
	...
	@Test
	public void testGetProductByExternalReferenceCodePinsPageWithSortCollection()
		throws Exception {
	...
	@Test
	public void testGetProductIdPinsPageWithSortCollection() throws Exception {
		JSONObject xSortableJSONObject = HTTPTestUtil.invokeToJSONObject(
			null, "headless-commerce-admin-catalog/v1.0/openapi.json",
			Http.Method.GET
		).getJSONObject(
...
// LIFERAY-REST-BUILDER-HASH:1748675795