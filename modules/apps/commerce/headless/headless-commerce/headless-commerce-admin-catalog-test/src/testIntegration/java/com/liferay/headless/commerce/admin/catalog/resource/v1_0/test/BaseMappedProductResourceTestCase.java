...
public abstract class BaseMappedProductResourceTestCase {
	...
	@Test
	public void testGetProductByExternalReferenceCodeMappedProductsPageWithSortCollection()
		throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				Method method = mappedProduct1.getClass(
				).getMethod(
					"get" + StringUtil.upperCaseFirstLetter(entityFieldName)
				);
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(
						mappedProduct1, entityFieldName, 0L);
					BeanTestUtil.setProperty(
						mappedProduct2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(
						mappedProduct1, entityFieldName, 0);
					BeanTestUtil.setProperty(
						mappedProduct2, entityFieldName, 1);
				}
	...
	@Test
	public void testGetProductIdMappedProductsPageWithSortCollection()
		throws Exception {
...
// LIFERAY-REST-BUILDER-HASH:-42409092