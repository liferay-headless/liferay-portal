...
public abstract class BaseSkuResourceTestCase {
	...
	@Test
	public void testGetSkuMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {

		Sku postSku = testGetSku_addSku();

		String endpoint = StringBundler.concat(
			"/headless-commerce-admin-catalog/v1.0/skus/{id}".replace(
				"{skuId}", String.valueOf(postSku.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
			...
			Assert.assertTrue(
				equals(
					SkuSerDes.toDTO(apiResponse),
					SkuSerDes.toDTO(vulcanResponse)));
		}
	}
