...
public abstract class BaseSkuResourceTestCase {
	...
	@Test
	public void testGetSkusPageWithSortCollection() throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(sku1, entityFieldName, 0L);
					BeanTestUtil.setProperty(sku2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(sku1, entityFieldName, 0);
					BeanTestUtil.setProperty(sku2, entityFieldName, 1);
				}
	...
	@Test
	public void testGetUnitOfMeasureSkusPageWithSortCollection()
		throws Exception {
...
// LIFERAY-REST-BUILDER-HASH:-195818861