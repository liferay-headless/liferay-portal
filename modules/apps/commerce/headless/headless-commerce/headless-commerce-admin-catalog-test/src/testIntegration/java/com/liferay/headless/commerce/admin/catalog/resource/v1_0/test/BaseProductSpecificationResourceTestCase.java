...
public abstract class BaseProductSpecificationResourceTestCase {
	...
	@Test
	public void testGetProductSpecificationMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {
		...
		String endpoint = StringBundler.concat(
			"/headless-commerce-admin-catalog/v1.0/productSpecifications/{id}".
				replace(
					"{productSpecificationId}",
					String.valueOf(postProductSpecification.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/productSpecifications/{id}".replace(
								"{productSpecificationId}",
								String.valueOf(
									postProductSpecification.getId()));
						}
			...
			Assert.assertTrue(
				equals(
					ProductSpecificationSerDes.toDTO(apiResponse),
					ProductSpecificationSerDes.toDTO(vulcanResponse)));
		}
	}
