...
public abstract class BaseOptionValueResourceTestCase {
	...
	@Test
	public void testGetOptionValueMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {

		OptionValue postOptionValue = testGetOptionValue_addOptionValue();

		String endpoint = StringBundler.concat(
			"/headless-commerce-admin-catalog/v1.0/optionValues/{id}".replace(
				"{optionValueId}", String.valueOf(postOptionValue.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/optionValues/{id}".replace(
								"{optionValueId}",
								String.valueOf(postOptionValue.getId()));
						}
			...
			Assert.assertTrue(
				equals(
					OptionValueSerDes.toDTO(apiResponse),
					OptionValueSerDes.toDTO(vulcanResponse)));
		}
	}
