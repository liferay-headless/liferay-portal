...
public abstract class BaseCatalogResourceTestCase {
	...
	@Test
	public void testGetCatalogsPageWithSortCollection() throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				Method method = catalog1.getClass(
				).getMethod(
					"get" + StringUtil.upperCaseFirstLetter(entityFieldName)
				);
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(catalog1, entityFieldName, 0L);
					BeanTestUtil.setProperty(catalog2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(catalog1, entityFieldName, 0);
					BeanTestUtil.setProperty(catalog2, entityFieldName, 1);
				}
...
// LIFERAY-REST-BUILDER-HASH:1452262659