...
public abstract class BaseOptionCategoryResourceTestCase {
	...
	@Test
	public void testGetOptionCategoriesPageWithSortCollection()
		throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				Method method = optionCategory1.getClass(
				).getMethod(
					"get" + StringUtil.upperCaseFirstLetter(entityFieldName)
				);
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(
						optionCategory1, entityFieldName, 0L);
					BeanTestUtil.setProperty(
						optionCategory2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(
						optionCategory1, entityFieldName, 0);
					BeanTestUtil.setProperty(
						optionCategory2, entityFieldName, 1);
				}
...
// LIFERAY-REST-BUILDER-HASH:-1560536334