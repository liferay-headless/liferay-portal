...
public abstract class BaseOptionCategoryResourceTestCase {
	...
	@Test
	public void testGetOptionCategoryMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {
		...
		String endpoint = StringBundler.concat(
			"/headless-commerce-admin-catalog/v1.0/optionCategories/{id}".
				replace(
					"{optionCategoryId}",
					String.valueOf(postOptionCategory.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/optionCategories/{id}".replace(
								"{optionCategoryId}",
								String.valueOf(postOptionCategory.getId()));
						}
			...
			Assert.assertTrue(
				equals(
					OptionCategorySerDes.toDTO(apiResponse),
					OptionCategorySerDes.toDTO(vulcanResponse)));
		}
	}
