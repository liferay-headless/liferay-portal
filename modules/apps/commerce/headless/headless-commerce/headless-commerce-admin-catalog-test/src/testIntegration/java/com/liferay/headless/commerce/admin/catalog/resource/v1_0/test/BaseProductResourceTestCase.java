...
public abstract class BaseProductResourceTestCase {
	...
	@Test
	public void testGetProductMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {

		Product postProduct = testGetProduct_addProduct();

		String endpoint = StringBundler.concat(
			"/headless-commerce-admin-catalog/v1.0/products/{id}".replace(
				"{productId}", String.valueOf(postProduct.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/products/{id}".replace(
								"{productId}",
								String.valueOf(postProduct.getId()));
						}
			...
			Assert.assertTrue(
				equals(
					ProductSerDes.toDTO(apiResponse),
					ProductSerDes.toDTO(vulcanResponse)));
		}
	}
