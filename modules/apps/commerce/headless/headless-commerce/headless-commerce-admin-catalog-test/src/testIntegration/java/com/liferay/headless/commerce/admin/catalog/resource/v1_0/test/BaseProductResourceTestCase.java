...
public abstract class BaseProductResourceTestCase {
	...
	@Test
	public void testGetProductsPageWithSortCollection() throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				Method method = product1.getClass(
				).getMethod(
					"get" + StringUtil.upperCaseFirstLetter(entityFieldName)
				);
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(product1, entityFieldName, 0L);
					BeanTestUtil.setProperty(product2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(product1, entityFieldName, 0);
					BeanTestUtil.setProperty(product2, entityFieldName, 1);
				}
...
// LIFERAY-REST-BUILDER-HASH:1723769092