...
public abstract class BasePinResourceTestCase {
	...
	@Test
	public void testGetChannelByExternalReferenceCodeChannelExternalReferenceCodeProductByExternalReferenceCodeProductExternalReferenceCodePinsPageWithSortCollection()
		throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(pin1, entityFieldName, 0L);
					BeanTestUtil.setProperty(pin2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(pin1, entityFieldName, 0);
					BeanTestUtil.setProperty(pin2, entityFieldName, 1);
				}
	...
	@Test
	public void testGetChannelProductPinsPageWithSortCollection()
		throws Exception {
...
// LIFERAY-REST-BUILDER-HASH:1020793980