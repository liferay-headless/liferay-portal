...
public class Attachment implements Serializable {
	...
	public Object getValue(String propertyName) {
		if (Objects.equals(propertyName, "attachment")) {
			return attachment;
		}
		else if (Objects.equals(propertyName, "attachment")) {
			return attachment;
		}
		else if (Objects.equals(propertyName, "cdnEnabled")) {
			return cdnEnabled;
		}
		else if (Objects.equals(propertyName, "cdnURL")) {
			return cdnURL;
		}
		...
		else if (Objects.equals(propertyName, "fileEntryId")) {
			return fileEntryId;
		}
