...
public abstract class BaseTaxCategoryResourceTestCase {
	...
	@Test
	public void testGetTaxCategoryMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {

		TaxCategory postTaxCategory = testGetTaxCategory_addTaxCategory();

		String endpoint = StringBundler.concat(
			"/headless-commerce-admin-channel/v1.0/tax-categories/{id}".replace(
				"{taxCategoryId}", String.valueOf(postTaxCategory.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/tax-categories/{id}".replace(
								"{taxCategoryId}",
								String.valueOf(postTaxCategory.getId()));
						}
			...
			Assert.assertTrue(
				equals(
					TaxCategorySerDes.toDTO(apiResponse),
					TaxCategorySerDes.toDTO(vulcanResponse)));
		}
	}
