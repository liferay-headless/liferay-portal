...
public abstract class BaseChannelAccountResourceTestCase {
	...
	@Test
	public void testGetChannelIdChannelAccountsPageWithSortCollection()
		throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				Method method = channelAccount1.getClass(
				).getMethod(
					"get" + StringUtil.upperCaseFirstLetter(entityFieldName)
				);
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(
						channelAccount1, entityFieldName, 0L);
					BeanTestUtil.setProperty(
						channelAccount2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(
						channelAccount1, entityFieldName, 0);
					BeanTestUtil.setProperty(
						channelAccount2, entityFieldName, 1);
				}
...
// LIFERAY-REST-BUILDER-HASH:-644786079