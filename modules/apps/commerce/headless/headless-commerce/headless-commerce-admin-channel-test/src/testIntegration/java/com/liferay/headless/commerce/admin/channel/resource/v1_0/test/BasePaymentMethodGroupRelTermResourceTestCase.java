...
public abstract class BasePaymentMethodGroupRelTermResourceTestCase {
	...
	@Test
	public void testGetPaymentMethodGroupRelIdPaymentMethodGroupRelTermsPageWithSortCollection()
		throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				Method method = paymentMethodGroupRelTerm1.getClass(
				).getMethod(
					"get" + StringUtil.upperCaseFirstLetter(entityFieldName)
				);
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(
						paymentMethodGroupRelTerm1, entityFieldName, 0L);
					BeanTestUtil.setProperty(
						paymentMethodGroupRelTerm2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(
						paymentMethodGroupRelTerm1, entityFieldName, 0);
					BeanTestUtil.setProperty(
						paymentMethodGroupRelTerm2, entityFieldName, 1);
				}
...
// LIFERAY-REST-BUILDER-HASH:-2086369815