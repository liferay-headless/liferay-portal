...
public abstract class BaseAccountAddressChannelResourceTestCase {
	...
	@Test
	public void testGetAccountAddressIdAccountAddressChannelsPageWithSortCollection()
		throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				Method method = accountAddressChannel1.getClass(
				).getMethod(
					"get" + StringUtil.upperCaseFirstLetter(entityFieldName)
				);
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(
						accountAddressChannel1, entityFieldName, 0L);
					BeanTestUtil.setProperty(
						accountAddressChannel2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(
						accountAddressChannel1, entityFieldName, 0);
					BeanTestUtil.setProperty(
						accountAddressChannel2, entityFieldName, 1);
				}
...
// LIFERAY-REST-BUILDER-HASH:1735500470