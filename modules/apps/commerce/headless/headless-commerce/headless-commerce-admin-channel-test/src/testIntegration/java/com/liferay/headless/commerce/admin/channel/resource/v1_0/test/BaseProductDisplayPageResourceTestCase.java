...
public abstract class BaseProductDisplayPageResourceTestCase {
	...
	@Test
	public void testGetProductDisplayPageMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {
		...
		String endpoint = StringBundler.concat(
			"/headless-commerce-admin-channel/v1.0/product-display-pages/{id}".
				replace(
					"{productDisplayPageId}",
					String.valueOf(postProductDisplayPage.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/product-display-pages/{id}".replace(
								"{productDisplayPageId}",
								String.valueOf(postProductDisplayPage.getId()));
						}
			...
			Assert.assertTrue(
				equals(
					ProductDisplayPageSerDes.toDTO(apiResponse),
					ProductDisplayPageSerDes.toDTO(vulcanResponse)));
		}
	}
