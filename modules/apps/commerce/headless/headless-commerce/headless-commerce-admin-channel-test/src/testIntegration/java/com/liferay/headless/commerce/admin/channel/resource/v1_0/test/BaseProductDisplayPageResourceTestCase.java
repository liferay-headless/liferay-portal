...
public abstract class BaseProductDisplayPageResourceTestCase {
	...
	@Test
	public void testGetChannelByExternalReferenceCodeProductDisplayPagesPageWithSortCollection()
		throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				Method method = productDisplayPage1.getClass(
				).getMethod(
					"get" + StringUtil.upperCaseFirstLetter(entityFieldName)
				);
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(
						productDisplayPage1, entityFieldName, 0L);
					BeanTestUtil.setProperty(
						productDisplayPage2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(
						productDisplayPage1, entityFieldName, 0);
					BeanTestUtil.setProperty(
						productDisplayPage2, entityFieldName, 1);
				}
	...
	@Test
	public void testGetChannelIdProductDisplayPagesPageWithSortCollection()
		throws Exception {
...
// LIFERAY-REST-BUILDER-HASH:-532111180