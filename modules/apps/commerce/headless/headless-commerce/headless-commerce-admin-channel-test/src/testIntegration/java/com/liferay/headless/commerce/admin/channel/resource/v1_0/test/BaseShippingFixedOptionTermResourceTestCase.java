...
public abstract class BaseShippingFixedOptionTermResourceTestCase {
	...
	@Test
	public void testGetShippingFixedOptionIdShippingFixedOptionTermsPageWithSortCollection()
		throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				Method method = shippingFixedOptionTerm1.getClass(
				).getMethod(
					"get" + StringUtil.upperCaseFirstLetter(entityFieldName)
				);
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(
						shippingFixedOptionTerm1, entityFieldName, 0L);
					BeanTestUtil.setProperty(
						shippingFixedOptionTerm2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(
						shippingFixedOptionTerm1, entityFieldName, 0);
					BeanTestUtil.setProperty(
						shippingFixedOptionTerm2, entityFieldName, 1);
				}
...
// LIFERAY-REST-BUILDER-HASH:-610526243