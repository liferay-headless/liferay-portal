...
public abstract class BaseCategoryDisplayPageResourceTestCase {
	...
	@Test
	public void testGetCategoryDisplayPageMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {
		...
		String endpoint = StringBundler.concat(
			"/headless-commerce-admin-channel/v1.0/category-display-pages/{id}".
				replace(
					"{categoryDisplayPageId}",
					String.valueOf(postCategoryDisplayPage.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/category-display-pages/{id}".replace(
								"{categoryDisplayPageId}",
								String.valueOf(
									postCategoryDisplayPage.getId()));
						}
			...
			Assert.assertTrue(
				equals(
					CategoryDisplayPageSerDes.toDTO(apiResponse),
					CategoryDisplayPageSerDes.toDTO(vulcanResponse)));
		}
	}
