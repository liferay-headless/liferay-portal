...
public abstract class BaseWarehouseItemResourceTestCase {
	...
	@Test
	public void testGetWarehouseItemMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {
		...
		String endpoint = StringBundler.concat(
			"/headless-commerce-admin-inventory/v1.0/warehouseItems/{id}".
				replace(
					"{warehouseItemId}",
					String.valueOf(postWarehouseItem.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/warehouseItems/{id}".replace(
								"{warehouseItemId}",
								String.valueOf(postWarehouseItem.getId()));
						}
			...
			Assert.assertTrue(
				equals(
					WarehouseItemSerDes.toDTO(apiResponse),
					WarehouseItemSerDes.toDTO(vulcanResponse)));
		}
	}
