...
public abstract class BaseReplenishmentItemResourceTestCase {
	...
	@Test
	public void testGetReplenishmentItemMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {
		...
		String endpoint = StringBundler.concat(
			"/headless-commerce-admin-inventory/v1.0/replenishment-items/{replenishmentItemId}".
				replace(
					"{replenishmentItemId}",
					String.valueOf(postReplenishmentItem.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/replenishment-items/{replenishmentItemId}".
								replace(
									"{replenishmentItemId}",
									String.valueOf(
										postReplenishmentItem.getId()));
			...
			Assert.assertTrue(
				equals(
					ReplenishmentItemSerDes.toDTO(apiResponse),
					ReplenishmentItemSerDes.toDTO(vulcanResponse)));
		}
	}
