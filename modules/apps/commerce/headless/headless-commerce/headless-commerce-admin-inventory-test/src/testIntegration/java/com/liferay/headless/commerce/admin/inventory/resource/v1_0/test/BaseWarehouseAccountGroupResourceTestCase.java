...
public abstract class BaseWarehouseAccountGroupResourceTestCase {
	...
	@Test
	public void testGetWarehouseIdWarehouseAccountGroupsPageWithSortCollection()
		throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				Method method = warehouseAccountGroup1.getClass(
				).getMethod(
					"get" + StringUtil.upperCaseFirstLetter(entityFieldName)
				);
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(
						warehouseAccountGroup1, entityFieldName, 0L);
					BeanTestUtil.setProperty(
						warehouseAccountGroup2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(
						warehouseAccountGroup1, entityFieldName, 0);
					BeanTestUtil.setProperty(
						warehouseAccountGroup2, entityFieldName, 1);
				}
...
// LIFERAY-REST-BUILDER-HASH:610832252