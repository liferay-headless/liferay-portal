...
public abstract class BaseWarehouseAccountResourceTestCase {
	...
	@Test
	public void testGetWarehouseIdWarehouseAccountsPageWithSortCollection()
		throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				Method method = warehouseAccount1.getClass(
				).getMethod(
					"get" + StringUtil.upperCaseFirstLetter(entityFieldName)
				);
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(
						warehouseAccount1, entityFieldName, 0L);
					BeanTestUtil.setProperty(
						warehouseAccount2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(
						warehouseAccount1, entityFieldName, 0);
					BeanTestUtil.setProperty(
						warehouseAccount2, entityFieldName, 1);
				}
...
// LIFERAY-REST-BUILDER-HASH:706748117