...
public abstract class BaseWarehouseOrderTypeResourceTestCase {
	...
	@Test
	public void testGetWarehouseIdWarehouseOrderTypesPageWithSortCollection()
		throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				Method method = warehouseOrderType1.getClass(
				).getMethod(
					"get" + StringUtil.upperCaseFirstLetter(entityFieldName)
				);
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(
						warehouseOrderType1, entityFieldName, 0L);
					BeanTestUtil.setProperty(
						warehouseOrderType2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(
						warehouseOrderType1, entityFieldName, 0);
					BeanTestUtil.setProperty(
						warehouseOrderType2, entityFieldName, 1);
				}
...
// LIFERAY-REST-BUILDER-HASH:-413883425