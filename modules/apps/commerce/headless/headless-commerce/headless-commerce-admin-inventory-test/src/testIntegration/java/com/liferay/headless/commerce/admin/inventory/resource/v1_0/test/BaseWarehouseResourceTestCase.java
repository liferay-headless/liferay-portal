...
public abstract class BaseWarehouseResourceTestCase {
	...
	@Test
	public void testGetWarehousesPageWithSortCollection() throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				Method method = warehouse1.getClass(
				).getMethod(
					"get" + StringUtil.upperCaseFirstLetter(entityFieldName)
				);
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(warehouse1, entityFieldName, 0L);
					BeanTestUtil.setProperty(warehouse2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(warehouse1, entityFieldName, 0);
					BeanTestUtil.setProperty(warehouse2, entityFieldName, 1);
				}
...
// LIFERAY-REST-BUILDER-HASH:-1409926795