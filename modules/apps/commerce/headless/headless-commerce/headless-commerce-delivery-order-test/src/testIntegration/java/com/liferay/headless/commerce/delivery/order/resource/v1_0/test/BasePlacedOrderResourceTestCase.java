...
public abstract class BasePlacedOrderResourceTestCase {
	...
	@Test
	public void testGetPlacedOrderMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {

		PlacedOrder postPlacedOrder = testGetPlacedOrder_addPlacedOrder();

		String endpoint = StringBundler.concat(
			"/headless-commerce-delivery-order/v1.0/placed-orders/{placedOrderId}".
				replace(
					"{placedOrderId}",
					String.valueOf(postPlacedOrder.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/placed-orders/{placedOrderId}".replace(
								"{placedOrderId}",
								String.valueOf(postPlacedOrder.getId()));
						}
			...
			Assert.assertTrue(
				equals(
					PlacedOrderSerDes.toDTO(apiResponse),
					PlacedOrderSerDes.toDTO(vulcanResponse)));
		}
	}
