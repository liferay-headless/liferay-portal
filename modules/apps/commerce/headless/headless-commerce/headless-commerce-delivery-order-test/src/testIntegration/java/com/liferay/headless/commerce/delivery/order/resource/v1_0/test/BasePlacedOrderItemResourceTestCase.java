...
public abstract class BasePlacedOrderItemResourceTestCase {
	...
	@Test
	public void testGetPlacedOrderItemMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {
		...
		String endpoint = StringBundler.concat(
			"/headless-commerce-delivery-order/v1.0/placed-order-items/{placedOrderItemId}".
				replace(
					"{placedOrderItemId}",
					String.valueOf(postPlacedOrderItem.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/placed-order-items/{placedOrderItemId}".
								replace(
									"{placedOrderItemId}",
									String.valueOf(
										postPlacedOrderItem.getId()));
			...
			Assert.assertTrue(
				equals(
					PlacedOrderItemSerDes.toDTO(apiResponse),
					PlacedOrderItemSerDes.toDTO(vulcanResponse)));
		}
	}
