...
public abstract class BasePlacedOrderItemResourceTestCase {
	...
	@Test
	public void testGetPlacedOrderByExternalReferenceCodePlacedOrderItemsPageWithSortCollection()
		throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				Method method = placedOrderItem1.getClass(
				).getMethod(
					"get" + StringUtil.upperCaseFirstLetter(entityFieldName)
				);
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(
						placedOrderItem1, entityFieldName, 0L);
					BeanTestUtil.setProperty(
						placedOrderItem2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(
						placedOrderItem1, entityFieldName, 0);
					BeanTestUtil.setProperty(
						placedOrderItem2, entityFieldName, 1);
				}
	...
	@Test
	public void testGetPlacedOrderPlacedOrderItemsPageWithSortCollection()
		throws Exception {
...
// LIFERAY-REST-BUILDER-HASH:-442987728