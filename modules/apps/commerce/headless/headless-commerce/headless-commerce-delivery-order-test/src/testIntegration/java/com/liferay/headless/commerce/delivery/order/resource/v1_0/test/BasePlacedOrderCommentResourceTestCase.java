...
public abstract class BasePlacedOrderCommentResourceTestCase {
	...
	@Test
	public void testGetPlacedOrderCommentMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {
		...
		String endpoint = StringBundler.concat(
			"/headless-commerce-delivery-order/v1.0/placed-order-comments/{placedOrderCommentId}".
				replace(
					"{placedOrderCommentId}",
					String.valueOf(postPlacedOrderComment.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/placed-order-comments/{placedOrderCommentId}".
								replace(
									"{placedOrderCommentId}",
									String.valueOf(
										postPlacedOrderComment.getId()));
			...
			Assert.assertTrue(
				equals(
					PlacedOrderCommentSerDes.toDTO(apiResponse),
					PlacedOrderCommentSerDes.toDTO(vulcanResponse)));
		}
	}
