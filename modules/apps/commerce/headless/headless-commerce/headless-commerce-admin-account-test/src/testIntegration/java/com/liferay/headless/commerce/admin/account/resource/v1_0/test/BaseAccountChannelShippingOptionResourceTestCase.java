...
public abstract class BaseAccountChannelShippingOptionResourceTestCase {
	...
	@Test
	public void testGetAccountChannelShippingOptionMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {
		...
		String endpoint = StringBundler.concat(
			"/headless-commerce-admin-account/v1.0/account-channel-shipping-options/{id}".
				replace(
					"{accountChannelShippingOptionId}",
					String.valueOf(postAccountChannelShippingOption.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/account-channel-shipping-options/{id}".
								replace(
									"{accountChannelShippingOptionId}",
									String.valueOf(
			...
			Assert.assertTrue(
				equals(
					AccountChannelShippingOptionSerDes.toDTO(apiResponse),
					AccountChannelShippingOptionSerDes.toDTO(vulcanResponse)));
		}
	}
