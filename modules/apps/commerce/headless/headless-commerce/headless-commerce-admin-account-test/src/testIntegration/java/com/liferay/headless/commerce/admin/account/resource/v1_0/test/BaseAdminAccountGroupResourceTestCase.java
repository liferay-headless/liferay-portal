...
public abstract class BaseAdminAccountGroupResourceTestCase {
	...
	@Test
	public void testGetAccountGroupsPageWithSortCollection() throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				Method method = adminAccountGroup1.getClass(
				).getMethod(
					"get" + StringUtil.upperCaseFirstLetter(entityFieldName)
				);
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(
						adminAccountGroup1, entityFieldName, 0L);
					BeanTestUtil.setProperty(
						adminAccountGroup2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(
						adminAccountGroup1, entityFieldName, 0);
					BeanTestUtil.setProperty(
						adminAccountGroup2, entityFieldName, 1);
				}
...
// LIFERAY-REST-BUILDER-HASH:632214125