...
public abstract class BaseOrderRuleResourceTestCase {
	...
	@Test
	public void testGetOrderRulesPageWithSortCollection() throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				Method method = orderRule1.getClass(
				).getMethod(
					"get" + StringUtil.upperCaseFirstLetter(entityFieldName)
				);
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(orderRule1, entityFieldName, 0L);
					BeanTestUtil.setProperty(orderRule2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(orderRule1, entityFieldName, 0);
					BeanTestUtil.setProperty(orderRule2, entityFieldName, 1);
				}
...
// LIFERAY-REST-BUILDER-HASH:-448922085