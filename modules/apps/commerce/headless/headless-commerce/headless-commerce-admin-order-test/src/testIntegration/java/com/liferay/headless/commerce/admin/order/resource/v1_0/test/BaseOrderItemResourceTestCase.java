...
public abstract class BaseOrderItemResourceTestCase {
	...
	@Test
	public void testGetOrderItemMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {

		OrderItem postOrderItem = testGetOrderItem_addOrderItem();

		String endpoint = StringBundler.concat(
			"/headless-commerce-admin-order/v1.0/orderItems/{id}".replace(
				"{orderItemId}", String.valueOf(postOrderItem.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/orderItems/{id}".replace(
								"{orderItemId}",
								String.valueOf(postOrderItem.getId()));
						}
			...
			Assert.assertTrue(
				equals(
					OrderItemSerDes.toDTO(apiResponse),
					OrderItemSerDes.toDTO(vulcanResponse)));
		}
	}
