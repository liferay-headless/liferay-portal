...
public abstract class BaseOrderRuleChannelResourceTestCase {
	...
	@Test
	public void testGetOrderRuleIdOrderRuleChannelsPageWithSortCollection()
		throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				Method method = orderRuleChannel1.getClass(
				).getMethod(
					"get" + StringUtil.upperCaseFirstLetter(entityFieldName)
				);
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(
						orderRuleChannel1, entityFieldName, 0L);
					BeanTestUtil.setProperty(
						orderRuleChannel2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(
						orderRuleChannel1, entityFieldName, 0);
					BeanTestUtil.setProperty(
						orderRuleChannel2, entityFieldName, 1);
				}
...
// LIFERAY-REST-BUILDER-HASH:1745810413