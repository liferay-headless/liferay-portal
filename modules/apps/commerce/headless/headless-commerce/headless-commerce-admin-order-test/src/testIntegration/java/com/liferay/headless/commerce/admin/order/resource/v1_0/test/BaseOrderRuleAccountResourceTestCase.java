...
public abstract class BaseOrderRuleAccountResourceTestCase {
	...
	@Test
	public void testGetOrderRuleIdOrderRuleAccountsPageWithSortCollection()
		throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				Method method = orderRuleAccount1.getClass(
				).getMethod(
					"get" + StringUtil.upperCaseFirstLetter(entityFieldName)
				);
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(
						orderRuleAccount1, entityFieldName, 0L);
					BeanTestUtil.setProperty(
						orderRuleAccount2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(
						orderRuleAccount1, entityFieldName, 0);
					BeanTestUtil.setProperty(
						orderRuleAccount2, entityFieldName, 1);
				}
...
// LIFERAY-REST-BUILDER-HASH:288195151