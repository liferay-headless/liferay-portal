...
public abstract class BaseTermResourceTestCase {
	...
	@Test
	public void testGetTermsPageWithSortCollection() throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(term1, entityFieldName, 0L);
					BeanTestUtil.setProperty(term2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(term1, entityFieldName, 0);
					BeanTestUtil.setProperty(term2, entityFieldName, 1);
				}
...
// LIFERAY-REST-BUILDER-HASH:942526829