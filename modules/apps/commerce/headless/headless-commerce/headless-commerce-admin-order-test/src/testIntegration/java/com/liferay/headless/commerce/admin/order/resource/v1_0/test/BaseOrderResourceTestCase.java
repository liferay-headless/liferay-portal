...
public abstract class BaseOrderResourceTestCase {
	...
	@Test
	public void testGetOrdersPageWithSortCollection() throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(order1, entityFieldName, 0L);
					BeanTestUtil.setProperty(order2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(order1, entityFieldName, 0);
					BeanTestUtil.setProperty(order2, entityFieldName, 1);
				}
...
// LIFERAY-REST-BUILDER-HASH:-2079345534