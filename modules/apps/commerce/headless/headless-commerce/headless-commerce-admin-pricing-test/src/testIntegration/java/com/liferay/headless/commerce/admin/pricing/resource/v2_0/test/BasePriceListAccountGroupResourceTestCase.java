...
public abstract class BasePriceListAccountGroupResourceTestCase {
	...
	@Test
	public void testGetPriceListIdPriceListAccountGroupsPageWithSortCollection()
		throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				Method method = priceListAccountGroup1.getClass(
				).getMethod(
					"get" + StringUtil.upperCaseFirstLetter(entityFieldName)
				);
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(
						priceListAccountGroup1, entityFieldName, 0L);
					BeanTestUtil.setProperty(
						priceListAccountGroup2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(
						priceListAccountGroup1, entityFieldName, 0);
					BeanTestUtil.setProperty(
						priceListAccountGroup2, entityFieldName, 1);
				}
...
// LIFERAY-REST-BUILDER-HASH:1343037023