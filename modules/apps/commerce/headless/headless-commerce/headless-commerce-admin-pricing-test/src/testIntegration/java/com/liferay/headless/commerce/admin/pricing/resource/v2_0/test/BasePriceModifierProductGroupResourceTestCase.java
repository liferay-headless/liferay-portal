...
public abstract class BasePriceModifierProductGroupResourceTestCase {
	...
	@Test
	public void testGetPriceModifierIdPriceModifierProductGroupsPageWithSortCollection()
		throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				Method method = priceModifierProductGroup1.getClass(
				).getMethod(
					"get" + StringUtil.upperCaseFirstLetter(entityFieldName)
				);
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(
						priceModifierProductGroup1, entityFieldName, 0L);
					BeanTestUtil.setProperty(
						priceModifierProductGroup2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(
						priceModifierProductGroup1, entityFieldName, 0);
					BeanTestUtil.setProperty(
						priceModifierProductGroup2, entityFieldName, 1);
				}
...
// LIFERAY-REST-BUILDER-HASH:-351287910