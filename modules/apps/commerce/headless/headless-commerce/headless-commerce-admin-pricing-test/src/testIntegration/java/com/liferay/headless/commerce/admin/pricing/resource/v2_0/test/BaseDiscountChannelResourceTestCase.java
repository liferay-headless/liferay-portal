...
public abstract class BaseDiscountChannelResourceTestCase {
	...
	@Test
	public void testGetDiscountIdDiscountChannelsPageWithSortCollection()
		throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				Method method = discountChannel1.getClass(
				).getMethod(
					"get" + StringUtil.upperCaseFirstLetter(entityFieldName)
				);
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(
						discountChannel1, entityFieldName, 0L);
					BeanTestUtil.setProperty(
						discountChannel2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(
						discountChannel1, entityFieldName, 0);
					BeanTestUtil.setProperty(
						discountChannel2, entityFieldName, 1);
				}
...
// LIFERAY-REST-BUILDER-HASH:2157017