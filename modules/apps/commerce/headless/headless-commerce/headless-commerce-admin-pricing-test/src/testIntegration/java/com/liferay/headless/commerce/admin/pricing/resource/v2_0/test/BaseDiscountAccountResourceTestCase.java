...
public abstract class BaseDiscountAccountResourceTestCase {
	...
	@Test
	public void testGetDiscountIdDiscountAccountsPageWithSortCollection()
		throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				Method method = discountAccount1.getClass(
				).getMethod(
					"get" + StringUtil.upperCaseFirstLetter(entityFieldName)
				);
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(
						discountAccount1, entityFieldName, 0L);
					BeanTestUtil.setProperty(
						discountAccount2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(
						discountAccount1, entityFieldName, 0);
					BeanTestUtil.setProperty(
						discountAccount2, entityFieldName, 1);
				}
...
// LIFERAY-REST-BUILDER-HASH:-59693745