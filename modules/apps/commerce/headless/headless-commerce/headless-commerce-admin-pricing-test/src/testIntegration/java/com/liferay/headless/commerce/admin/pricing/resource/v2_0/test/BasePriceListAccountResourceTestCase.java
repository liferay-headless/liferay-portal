...
public abstract class BasePriceListAccountResourceTestCase {
	...
	@Test
	public void testGetPriceListIdPriceListAccountsPageWithSortCollection()
		throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				Method method = priceListAccount1.getClass(
				).getMethod(
					"get" + StringUtil.upperCaseFirstLetter(entityFieldName)
				);
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(
						priceListAccount1, entityFieldName, 0L);
					BeanTestUtil.setProperty(
						priceListAccount2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(
						priceListAccount1, entityFieldName, 0);
					BeanTestUtil.setProperty(
						priceListAccount2, entityFieldName, 1);
				}
...
// LIFERAY-REST-BUILDER-HASH:-105973360