...
public abstract class BasePriceModifierProductResourceTestCase {
	...
	@Test
	public void testGetPriceModifierIdPriceModifierProductsPageWithSortCollection()
		throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				Method method = priceModifierProduct1.getClass(
				).getMethod(
					"get" + StringUtil.upperCaseFirstLetter(entityFieldName)
				);
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(
						priceModifierProduct1, entityFieldName, 0L);
					BeanTestUtil.setProperty(
						priceModifierProduct2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(
						priceModifierProduct1, entityFieldName, 0);
					BeanTestUtil.setProperty(
						priceModifierProduct2, entityFieldName, 1);
				}
...
// LIFERAY-REST-BUILDER-HASH:-789918793