...
public abstract class BasePriceModifierCategoryResourceTestCase {
	...
	@Test
	public void testGetPriceModifierIdPriceModifierCategoriesPageWithSortCollection()
		throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				Method method = priceModifierCategory1.getClass(
				).getMethod(
					"get" + StringUtil.upperCaseFirstLetter(entityFieldName)
				);
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(
						priceModifierCategory1, entityFieldName, 0L);
					BeanTestUtil.setProperty(
						priceModifierCategory2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(
						priceModifierCategory1, entityFieldName, 0);
					BeanTestUtil.setProperty(
						priceModifierCategory2, entityFieldName, 1);
				}
...
// LIFERAY-REST-BUILDER-HASH:1203803476