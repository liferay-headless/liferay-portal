...
public abstract class BaseDiscountOrderTypeResourceTestCase {
	...
	@Test
	public void testGetDiscountIdDiscountOrderTypesPageWithSortCollection()
		throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				Method method = discountOrderType1.getClass(
				).getMethod(
					"get" + StringUtil.upperCaseFirstLetter(entityFieldName)
				);
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(
						discountOrderType1, entityFieldName, 0L);
					BeanTestUtil.setProperty(
						discountOrderType2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(
						discountOrderType1, entityFieldName, 0);
					BeanTestUtil.setProperty(
						discountOrderType2, entityFieldName, 1);
				}
...
// LIFERAY-REST-BUILDER-HASH:-1480594469