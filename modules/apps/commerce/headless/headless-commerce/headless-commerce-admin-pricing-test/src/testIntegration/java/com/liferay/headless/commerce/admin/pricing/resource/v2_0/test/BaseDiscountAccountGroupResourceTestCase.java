...
public abstract class BaseDiscountAccountGroupResourceTestCase {
	...
	@Test
	public void testGetDiscountIdDiscountAccountGroupsPageWithSortCollection()
		throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				Method method = discountAccountGroup1.getClass(
				).getMethod(
					"get" + StringUtil.upperCaseFirstLetter(entityFieldName)
				);
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(
						discountAccountGroup1, entityFieldName, 0L);
					BeanTestUtil.setProperty(
						discountAccountGroup2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(
						discountAccountGroup1, entityFieldName, 0);
					BeanTestUtil.setProperty(
						discountAccountGroup2, entityFieldName, 1);
				}
...
// LIFERAY-REST-BUILDER-HASH:-552219762