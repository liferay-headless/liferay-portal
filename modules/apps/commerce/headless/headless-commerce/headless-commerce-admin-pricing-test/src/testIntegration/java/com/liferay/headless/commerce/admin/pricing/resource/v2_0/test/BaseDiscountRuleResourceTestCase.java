...
public abstract class BaseDiscountRuleResourceTestCase {
	...
	@Test
	public void testGetDiscountIdDiscountRulesPageWithSortCollection()
		throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				Method method = discountRule1.getClass(
				).getMethod(
					"get" + StringUtil.upperCaseFirstLetter(entityFieldName)
				);
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(
						discountRule1, entityFieldName, 0L);
					BeanTestUtil.setProperty(
						discountRule2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(discountRule1, entityFieldName, 0);
					BeanTestUtil.setProperty(discountRule2, entityFieldName, 1);
				}
...
// LIFERAY-REST-BUILDER-HASH:120918340