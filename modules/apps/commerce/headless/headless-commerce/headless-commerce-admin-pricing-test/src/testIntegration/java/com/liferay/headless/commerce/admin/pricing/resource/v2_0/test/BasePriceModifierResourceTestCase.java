...
public abstract class BasePriceModifierResourceTestCase {
	...
	@Test
	public void testGetPriceModifierMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {
		...
		String endpoint = StringBundler.concat(
			"/headless-commerce-admin-pricing/v2.0/price-modifiers/{id}".
				replace(
					"{priceModifierId}",
					String.valueOf(postPriceModifier.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v2.0/price-modifiers/{id}".replace(
								"{priceModifierId}",
								String.valueOf(postPriceModifier.getId()));
						}
			...
			Assert.assertTrue(
				equals(
					PriceModifierSerDes.toDTO(apiResponse),
					PriceModifierSerDes.toDTO(vulcanResponse)));
		}
	}
