...
public abstract class BasePriceModifierResourceTestCase {
	...
	@Test
	public void testGetPriceListIdPriceModifiersPageWithSortCollection()
		throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				Method method = priceModifier1.getClass(
				).getMethod(
					"get" + StringUtil.upperCaseFirstLetter(entityFieldName)
				);
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(
						priceModifier1, entityFieldName, 0L);
					BeanTestUtil.setProperty(
						priceModifier2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(
						priceModifier1, entityFieldName, 0);
					BeanTestUtil.setProperty(
						priceModifier2, entityFieldName, 1);
				}
...
// LIFERAY-REST-BUILDER-HASH:-926279029