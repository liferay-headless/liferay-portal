...
public abstract class BaseDiscountSkuResourceTestCase {
	...
	@Test
	public void testGetDiscountIdDiscountSkusPageWithSortCollection()
		throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				Method method = discountSku1.getClass(
				).getMethod(
					"get" + StringUtil.upperCaseFirstLetter(entityFieldName)
				);
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(discountSku1, entityFieldName, 0L);
					BeanTestUtil.setProperty(discountSku2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(discountSku1, entityFieldName, 0);
					BeanTestUtil.setProperty(discountSku2, entityFieldName, 1);
				}
...
// LIFERAY-REST-BUILDER-HASH:-829260962