...
public abstract class BasePriceListChannelResourceTestCase {
	...
	@Test
	public void testGetPriceListIdPriceListChannelsPageWithSortCollection()
		throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				Method method = priceListChannel1.getClass(
				).getMethod(
					"get" + StringUtil.upperCaseFirstLetter(entityFieldName)
				);
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(
						priceListChannel1, entityFieldName, 0L);
					BeanTestUtil.setProperty(
						priceListChannel2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(
						priceListChannel1, entityFieldName, 0);
					BeanTestUtil.setProperty(
						priceListChannel2, entityFieldName, 1);
				}
...
// LIFERAY-REST-BUILDER-HASH:-967085364