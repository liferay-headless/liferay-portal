...
public abstract class BaseDiscountResourceTestCase {
	...
	@Test
	public void testGetDiscountsPageWithSortCollection() throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				Method method = discount1.getClass(
				).getMethod(
					"get" + StringUtil.upperCaseFirstLetter(entityFieldName)
				);
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(discount1, entityFieldName, 0L);
					BeanTestUtil.setProperty(discount2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(discount1, entityFieldName, 0);
					BeanTestUtil.setProperty(discount2, entityFieldName, 1);
				}
...
// LIFERAY-REST-BUILDER-HASH:1755859103