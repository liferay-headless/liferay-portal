...
public abstract class BasePriceListResourceTestCase {
	...
	@Test
	public void testGetPriceListMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {

		PriceList postPriceList = testGetPriceList_addPriceList();

		String endpoint = StringBundler.concat(
			"/headless-commerce-admin-pricing/v2.0/price-lists/{id}".replace(
				"{priceListId}", String.valueOf(postPriceList.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v2.0/price-lists/{id}".replace(
								"{priceListId}",
								String.valueOf(postPriceList.getId()));
						}
			...
			Assert.assertTrue(
				equals(
					PriceListSerDes.toDTO(apiResponse),
					PriceListSerDes.toDTO(vulcanResponse)));
		}
	}
