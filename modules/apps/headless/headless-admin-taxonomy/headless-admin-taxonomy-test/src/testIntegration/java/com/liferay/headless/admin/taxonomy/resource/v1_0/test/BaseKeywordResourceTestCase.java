...
public abstract class BaseKeywordResourceTestCase {
	...
	@Test
	public void testGetKeywordMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {

		Keyword postKeyword = testGetKeyword_addKeyword();

		String endpoint = StringBundler.concat(
			"/headless-admin-taxonomy/v1.0/keywords/{keywordId}".replace(
				"{keywordId}", String.valueOf(postKeyword.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/keywords/{keywordId}".replace(
								"{keywordId}",
								String.valueOf(postKeyword.getId()));
						}
			...
			Assert.assertTrue(
				equals(
					KeywordSerDes.toDTO(apiResponse),
					KeywordSerDes.toDTO(vulcanResponse)));
		}
	}
