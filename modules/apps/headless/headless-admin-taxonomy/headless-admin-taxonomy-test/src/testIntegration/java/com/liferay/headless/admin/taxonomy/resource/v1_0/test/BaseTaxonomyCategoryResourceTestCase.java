...
public abstract class BaseTaxonomyCategoryResourceTestCase {
		...
		assertHttpResponseStatusCode(
			...
			taxonomyCategoryResource.
				deleteSiteTaxonomyCategoryByExternalReferenceCodeHttpResponse(
					testDeleteSiteTaxonomyCategoryByExternalReferenceCode_getSiteId(
						taxonomyCategory),
					taxonomyCategory.getExternalReferenceCode()));
	...
	protected Long
		...
		return taxonomyCategory.getSiteId();
	}
		...
		TaxonomyCategory getTaxonomyCategory =
			taxonomyCategoryResource.
				getSiteTaxonomyCategoryByExternalReferenceCode(
					testGetSiteTaxonomyCategoryByExternalReferenceCode_getSiteId(
	...
	protected Long testGetSiteTaxonomyCategoryByExternalReferenceCode_getSiteId(
			TaxonomyCategory taxonomyCategory)
		throws Exception {
								...
								new HashMap<String, Object>() {
									{
										put(
											"siteKey",
											"\"" +
												testGraphQLGetSiteTaxonomyCategoryByExternalReferenceCode_getSiteId(
													taxonomyCategory) + "\"");
	...
	protected Long testPutSiteTaxonomyCategoryByExternalReferenceCode_getSiteId(
			TaxonomyCategory taxonomyCategory)
		throws Exception {
