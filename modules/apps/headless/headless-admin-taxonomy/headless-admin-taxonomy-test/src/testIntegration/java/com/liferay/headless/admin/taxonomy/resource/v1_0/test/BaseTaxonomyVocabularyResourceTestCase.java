...
public abstract class BaseTaxonomyVocabularyResourceTestCase {
	...
	@Test
	public void testGetTaxonomyVocabularyMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {
		...
		String endpoint = StringBundler.concat(
			"/headless-admin-taxonomy/v1.0/taxonomy-vocabularies/{taxonomyVocabularyId}".
				replace(
					"{taxonomyVocabularyId}",
					String.valueOf(postTaxonomyVocabulary.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/taxonomy-vocabularies/{taxonomyVocabularyId}".
								replace(
									"{taxonomyVocabularyId}",
									String.valueOf(
										postTaxonomyVocabulary.getId()));
			...
			Assert.assertTrue(
				equals(
					TaxonomyVocabularySerDes.toDTO(apiResponse),
					TaxonomyVocabularySerDes.toDTO(vulcanResponse)));
		}
	}
