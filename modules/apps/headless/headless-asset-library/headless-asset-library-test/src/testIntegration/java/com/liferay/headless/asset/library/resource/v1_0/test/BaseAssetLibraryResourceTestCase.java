...
public abstract class BaseAssetLibraryResourceTestCase {
	...
	@Test
	public void testGetAssetLibrariesPageWithSortCollection() throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				Method method = assetLibrary1.getClass(
				).getMethod(
					"get" + StringUtil.upperCaseFirstLetter(entityFieldName)
				);
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(
						assetLibrary1, entityFieldName, 0L);
					BeanTestUtil.setProperty(
						assetLibrary2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(assetLibrary1, entityFieldName, 0);
					BeanTestUtil.setProperty(assetLibrary2, entityFieldName, 1);
				}
...
// LIFERAY-REST-BUILDER-HASH:1339854308