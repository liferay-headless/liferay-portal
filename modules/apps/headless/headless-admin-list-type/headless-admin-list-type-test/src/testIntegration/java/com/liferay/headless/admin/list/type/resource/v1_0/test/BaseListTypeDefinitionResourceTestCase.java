...
public abstract class BaseListTypeDefinitionResourceTestCase {
	...
	@Test
	public void testGetListTypeDefinitionsPageWithSortCollection()
		throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				Method method = listTypeDefinition1.getClass(
				).getMethod(
					"get" + StringUtil.upperCaseFirstLetter(entityFieldName)
				);
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(
						listTypeDefinition1, entityFieldName, 0L);
					BeanTestUtil.setProperty(
						listTypeDefinition2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(
						listTypeDefinition1, entityFieldName, 0);
					BeanTestUtil.setProperty(
						listTypeDefinition2, entityFieldName, 1);
				}
...
// LIFERAY-REST-BUILDER-HASH:-274351399