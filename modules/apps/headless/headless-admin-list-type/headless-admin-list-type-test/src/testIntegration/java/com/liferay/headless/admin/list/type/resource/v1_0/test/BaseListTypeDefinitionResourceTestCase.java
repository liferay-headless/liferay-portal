...
public abstract class BaseListTypeDefinitionResourceTestCase {
	...
	@Test
	public void testGetListTypeDefinitionMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {
		...
		String endpoint = StringBundler.concat(
			"/headless-admin-list-type/v1.0/list-type-definitions/{listTypeDefinitionId}".
				replace(
					"{listTypeDefinitionId}",
					String.valueOf(postListTypeDefinition.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/list-type-definitions/{listTypeDefinitionId}".
								replace(
									"{listTypeDefinitionId}",
									String.valueOf(
										postListTypeDefinition.getId()));
			...
			Assert.assertTrue(
				equals(
					ListTypeDefinitionSerDes.toDTO(apiResponse),
					ListTypeDefinitionSerDes.toDTO(vulcanResponse)));
		}
	}
