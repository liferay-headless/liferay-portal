...
public abstract class BaseListTypeEntryResourceTestCase {
	...
	@Test
	public void testGetListTypeEntryMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {
		...
		String endpoint = StringBundler.concat(
			"/headless-admin-list-type/v1.0/list-type-entries/{listTypeEntryId}".
				replace(
					"{listTypeEntryId}",
					String.valueOf(postListTypeEntry.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/list-type-entries/{listTypeEntryId}".
								replace(
									"{listTypeEntryId}",
									String.valueOf(postListTypeEntry.getId()));
						}
			...
			Assert.assertTrue(
				equals(
					ListTypeEntrySerDes.toDTO(apiResponse),
					ListTypeEntrySerDes.toDTO(vulcanResponse)));
		}
	}
