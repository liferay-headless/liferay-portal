...
public class DisplayPageTemplate implements Serializable {
	...
	@Schema
	@Valid
	public DisplayPageTemplateSettings getDisplayPageSettings() {
		return displayPageSettings;
	}

	public void setDisplayPageSettings(
		DisplayPageTemplateSettings displayPageSettings) {

		this.displayPageSettings = displayPageSettings;
	}

	@JsonIgnore
	public void setDisplayPageSettings(
		UnsafeSupplier<DisplayPageTemplateSettings, Exception>
			displayPageSettingsUnsafeSupplier) {

		try {
			displayPageSettings = displayPageSettingsUnsafeSupplier.get();
		}
		catch (RuntimeException re) {
			throw re;
		}
	...
	@GraphQLField
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	protected DisplayPageTemplateSettings displayPageSettings;
	...
	public String toString() {
		...
		if (displayPageSettings != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}

			sb.append("\"displayPageSettings\": ");

			sb.append(String.valueOf(displayPageSettings));
		}
