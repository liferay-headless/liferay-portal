...
public abstract class BaseDisplayPageTemplateResourceTestCase {
	...
	protected void assertValid(DisplayPageTemplate displayPageTemplate)
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals(
					"displayPageSettings", additionalAssertFieldName)) {
	...
	protected boolean equals(
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals(
				...
				if (!Objects.deepEquals(
						displayPageTemplate1.getDisplayPageSettings(),
						displayPageTemplate2.getDisplayPageSettings())) {
	...
	protected String getFilterString(
		...
		if (entityFieldName.equals("displayPageSettings")) {
			throw new IllegalArgumentException(
				"Invalid entity field " + entityFieldName);
		}
		...
		if (entityFieldName.equals("key")) {
			sb.append("'");
			sb.append(String.valueOf(displayPageTemplate.getKey()));
			sb.append("'");
