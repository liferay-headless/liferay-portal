...
public class Query {
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {displayPageTemplate(displayPageTemplateKey: ___, siteKey: ___){actions, availableLanguages, creator, customFields, dateCreated, dateModified, displayPageSettings, key, markedAsDefault, pageDefinition, siteId, title, uuid}}"}' -u 'test@liferay.com:test'
	 */
