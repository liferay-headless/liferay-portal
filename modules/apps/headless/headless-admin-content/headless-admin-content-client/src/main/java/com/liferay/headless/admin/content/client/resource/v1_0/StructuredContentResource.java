...
public interface StructuredContentResource {
	...
	public com.liferay.headless.delivery.client.dto.v1_0.StructuredContent
			getStructuredContent(Long structuredContentId)
		throws Exception;
		...
		public com.liferay.headless.delivery.client.dto.v1_0.StructuredContent
			...
			try {
				return com.liferay.headless.delivery.client.serdes.v1_0.
					StructuredContentSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
