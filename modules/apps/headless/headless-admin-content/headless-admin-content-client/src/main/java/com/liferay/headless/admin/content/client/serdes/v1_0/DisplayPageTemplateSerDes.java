...
public class DisplayPageTemplateSerDes {
	...
	public static String toJSON(DisplayPageTemplate displayPageTemplate) {
		...
		if (displayPageTemplate.getCreator() != null) {
			...
			sb.append(String.valueOf(displayPageTemplate.getCreator()));
		}
		...
		if (displayPageTemplate.getDisplayPageSettings() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			sb.append(
				String.valueOf(displayPageTemplate.getDisplayPageSettings()));
		}
	...
	public static Map<String, String> toMap(
		...
		if (displayPageTemplate.getDisplayPageSettings() == null) {
			map.put("displayPageSettings", null);
		}
		else {
			map.put(
				"displayPageSettings",
			...
			if (Objects.equals(jsonParserFieldName, "actions")) {
				...
				if (jsonParserFieldValue != null) {
					displayPageTemplate.setDateModified(
						...
						jsonParserFieldName, "displayPageSettings")) {

				if (jsonParserFieldValue != null) {
					displayPageTemplate.setDisplayPageSettings(
