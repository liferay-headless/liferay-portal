...
import com.liferay.headless.admin.content.client.dto.v1_0.Experience;
import com.liferay.headless.admin.content.client.dto.v1_0.PageDefinition;
import com.liferay.headless.admin.content.client.dto.v1_0.PageSettings;
import com.liferay.headless.admin.content.client.dto.v1_0.RenderedPage;
...
public class SitePageSerDes {
	...
	public static String toJSON(SitePage sitePage) {
		...
		if (sitePage.getAggregateRating() != null) {
			...
			sb.append(sitePage.getAggregateRating());
		}
		...
		if (sitePage.getExperience() != null) {
			...
			sb.append(sitePage.getExperience());
		}
		...
		if (sitePage.getPageDefinition() != null) {
			...
			sb.append(sitePage.getPageDefinition());
		}
		...
		if (sitePage.getPageSettings() != null) {
			...
			sb.append(sitePage.getPageSettings());
		}
		...
		if (sitePage.getRenderedPage() != null) {
			...
			sb.append(sitePage.getRenderedPage());
		}
		...
		if (sitePage.getTaxonomyCategoryBriefs() != null) {
			...
			for (int i = 0; i < sitePage.getTaxonomyCategoryBriefs().length;
				...
				sb.append(sitePage.getTaxonomyCategoryBriefs()[i]);
	...
	public static class SitePageJSONParser extends BaseJSONParser<SitePage> {
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "actions")) {
				...
				if (jsonParserFieldValue != null) {
					sitePage.setCreator((Creator)jsonParserFieldValue);
				}
			}
				...
				if (jsonParserFieldValue != null) {
					sitePage.setExperience((Experience)jsonParserFieldValue);
				}
			}
				...
				if (jsonParserFieldValue != null) {
					sitePage.setPageSettings(
						(PageSettings)jsonParserFieldValue);
				}
			}
				...
				if (jsonParserFieldValue != null) {
					sitePage.setRenderedPage(
						(RenderedPage)jsonParserFieldValue);
				}
			}
