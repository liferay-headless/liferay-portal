...
import com.liferay.headless.admin.content.client.dto.v1_0.CustomMetaTag;
import com.liferay.headless.admin.content.client.dto.v1_0.OpenGraphSettings;
import com.liferay.headless.admin.content.client.dto.v1_0.PageSettings;
import com.liferay.headless.admin.content.client.dto.v1_0.SEOSettings;
	...
	public static String toJSON(PageSettings pageSettings) {
		...
		if (pageSettings.getCustomMetaTags() != null) {
			...
			for (int i = 0; i < pageSettings.getCustomMetaTags().length; i++) {
				sb.append(pageSettings.getCustomMetaTags()[i]);
		...
		if (pageSettings.getOpenGraphSettings() != null) {
			...
			sb.append(pageSettings.getOpenGraphSettings());
		}
		...
		if (pageSettings.getSeoSettings() != null) {
			...
			sb.append(pageSettings.getSeoSettings());
		}
			...
			if (Objects.equals(jsonParserFieldName, "customMetaTags")) {
				if (jsonParserFieldValue != null) {
					pageSettings.setCustomMetaTags(
						(CustomMetaTag[])jsonParserFieldValue);
				}
			}
