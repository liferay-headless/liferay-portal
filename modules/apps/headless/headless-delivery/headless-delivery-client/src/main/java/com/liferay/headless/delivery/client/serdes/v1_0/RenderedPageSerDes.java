...
public class RenderedPageSerDes {
	...
	public static String toJSON(RenderedPage renderedPage) {
		...
		if (renderedPage.getRenderedPageValue() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			sb.append(_escape(renderedPage.getRenderedPageValue()));
	...
	public static Map<String, String> toMap(RenderedPage renderedPage) {
		...
		if (renderedPage.getRenderedPageValue() == null) {
			map.put("renderedPageValue", null);
		}
		else {
			map.put(
				"renderedPageValue",
				String.valueOf(renderedPage.getRenderedPageValue()));
		}
	...
	public static class RenderedPageJSONParser
		...
		protected void setField(
			...
			else if (Objects.equals(jsonParserFieldName, "renderedPageValue")) {
				if (jsonParserFieldValue != null) {
					renderedPage.setRenderedPageValue(
						(String)jsonParserFieldValue);
				}
			}
