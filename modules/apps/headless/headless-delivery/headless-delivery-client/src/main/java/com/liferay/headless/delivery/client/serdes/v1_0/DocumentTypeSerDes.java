...
public class DocumentTypeSerDes {
	...
	public static String toJSON(DocumentType documentType) {
		...
		if (documentType.getMetadata() != null) {
			...
			for (int i = 0; i < documentType.getMetadata().length; i++) {
				sb.append(String.valueOf(documentType.getMetadata()[i]));

				if ((i + 1) < documentType.getMetadata().length) {
					sb.append(", ");
				}
			}
	...
	public static Map<String, String> toMap(DocumentType documentType) {
		...
		if (documentType.getMetadata() == null) {
			...
			map.put("metadata", String.valueOf(documentType.getMetadata()));
		}
	...
	public static class DocumentTypeJSONParser
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "description")) {
				...
				if (jsonParserFieldValue != null) {
					documentType.setMetadata(
						Stream.of(
							toStrings((Object[])jsonParserFieldValue)
						).map(
							object -> MetadataSerDes.toDTO((String)object)
						).toArray(
