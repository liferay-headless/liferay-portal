...
public interface ContentSetElementResource {
	...
	public HttpInvoker.HttpResponse getSiteContentSetsElementsPageHttpResponse(
			Long siteId, String search, String filterString,
			Pagination pagination, String sortString)
		throws Exception;
	...
	public static class ContentSetElementResourceImpl
		...
		public Page<ContentSetElement> getSiteContentSetsElementsPage(
			...
			HttpInvoker.HttpResponse httpResponse =
				getSiteContentSetsElementsPageHttpResponse(
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/headless-delivery/v1.0/sites/{siteId}/content-sets-elements",
				siteId);
