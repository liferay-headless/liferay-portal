...
public class ContentPageResourceTest extends BaseContentPageResourceTestCase {
	...
	@Override
	protected ContentPage testGetSiteContentPageExperienceExperienceKey_addContentPage()
		throws Exception {
		return _addContentPage();
	}
	...
	public void testGetSiteContentPageExperienceExperienceKeyRenderedPage()
		...
		String siteContentPageExperienceExperienceKeyRenderedPage =
			contentPageResource.getSiteContentPageExperienceExperienceKeyRenderedPage(
				testGroup.getGroupId(), friendlyURL.substring(1), segmentsExperience.getSegmentsExperienceKey());

		Assert.assertNotNull(siteContentPageExperienceExperienceKeyRenderedPage);
	}
