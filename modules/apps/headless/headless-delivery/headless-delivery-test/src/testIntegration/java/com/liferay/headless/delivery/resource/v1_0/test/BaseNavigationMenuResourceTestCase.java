...
public abstract class BaseNavigationMenuResourceTestCase {
	...
	@Test
	public void testGetNavigationMenuMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {
		...
		String endpoint = StringBundler.concat(
			"/headless-delivery/v1.0/navigation-menus/{navigationMenuId}".
				replace(
					"{navigationMenuId}",
					String.valueOf(postNavigationMenu.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/navigation-menus/{navigationMenuId}".
								replace(
									"{navigationMenuId}",
									String.valueOf(postNavigationMenu.getId()));
						}
			...
			Assert.assertTrue(
				equals(
					NavigationMenuSerDes.toDTO(apiResponse),
					NavigationMenuSerDes.toDTO(vulcanResponse)));
		}
	}
