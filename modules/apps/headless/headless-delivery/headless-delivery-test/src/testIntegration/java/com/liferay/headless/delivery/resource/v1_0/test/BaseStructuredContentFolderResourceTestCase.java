...
public abstract class BaseStructuredContentFolderResourceTestCase {
	...
	@Test
	public void testGetStructuredContentFolderMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {
		...
		String endpoint = StringBundler.concat(
			"/headless-delivery/v1.0/structured-content-folders/{structuredContentFolderId}".
				replace(
					"{structuredContentFolderId}",
					String.valueOf(postStructuredContentFolder.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/structured-content-folders/{structuredContentFolderId}".
								replace(
									"{structuredContentFolderId}",
									String.valueOf(
										postStructuredContentFolder.getId()));
			...
			Assert.assertTrue(
				equals(
					StructuredContentFolderSerDes.toDTO(apiResponse),
					StructuredContentFolderSerDes.toDTO(vulcanResponse)));
		}
	}
