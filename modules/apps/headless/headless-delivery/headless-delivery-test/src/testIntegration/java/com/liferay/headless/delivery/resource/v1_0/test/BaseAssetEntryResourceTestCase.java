...
public abstract class BaseAssetEntryResourceTestCase {
	...
	@Test
	public void testGetAssetEntriesPageWithSortCollection() throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				Method method = assetEntry1.getClass(
				).getMethod(
					"get" + StringUtil.upperCaseFirstLetter(entityFieldName)
				);
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(assetEntry1, entityFieldName, 0L);
					BeanTestUtil.setProperty(assetEntry2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(assetEntry1, entityFieldName, 0);
					BeanTestUtil.setProperty(assetEntry2, entityFieldName, 1);
				}
...
// LIFERAY-REST-BUILDER-HASH:-477184958