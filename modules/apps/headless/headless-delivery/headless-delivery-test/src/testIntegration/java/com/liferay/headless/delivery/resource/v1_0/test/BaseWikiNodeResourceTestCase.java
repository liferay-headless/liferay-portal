...
public abstract class BaseWikiNodeResourceTestCase {
	...
	@Test
	public void testGetSiteWikiNodesPageWithSortCollection() throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				Method method = wikiNode1.getClass(
				).getMethod(
					"get" + StringUtil.upperCaseFirstLetter(entityFieldName)
				);
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(wikiNode1, entityFieldName, 0L);
					BeanTestUtil.setProperty(wikiNode2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(wikiNode1, entityFieldName, 0);
					BeanTestUtil.setProperty(wikiNode2, entityFieldName, 1);
				}
...
// LIFERAY-REST-BUILDER-HASH:-999642080