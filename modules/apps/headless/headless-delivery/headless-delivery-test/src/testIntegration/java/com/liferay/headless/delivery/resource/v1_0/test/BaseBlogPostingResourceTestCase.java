...
public abstract class BaseBlogPostingResourceTestCase {
	...
	@Test
	public void testGetBlogPostingMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {

		BlogPosting postBlogPosting = testGetBlogPosting_addBlogPosting();

		String endpoint = StringBundler.concat(
			"/headless-delivery/v1.0/blog-postings/{blogPostingId}".replace(
				"{blogPostingId}", String.valueOf(postBlogPosting.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/blog-postings/{blogPostingId}".replace(
								"{blogPostingId}",
								String.valueOf(postBlogPosting.getId()));
						}
			...
			Assert.assertTrue(
				equals(
					BlogPostingSerDes.toDTO(apiResponse),
					BlogPostingSerDes.toDTO(vulcanResponse)));
		}
	}
