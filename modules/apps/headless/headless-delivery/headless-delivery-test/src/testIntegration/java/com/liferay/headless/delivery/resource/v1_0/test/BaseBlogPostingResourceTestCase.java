...
public abstract class BaseBlogPostingResourceTestCase {
	...
	@Test
	public void testGetSiteBlogPostingsPageWithSortCollection()
		throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				Method method = blogPosting1.getClass(
				).getMethod(
					"get" + StringUtil.upperCaseFirstLetter(entityFieldName)
				);
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(blogPosting1, entityFieldName, 0L);
					BeanTestUtil.setProperty(blogPosting2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(blogPosting1, entityFieldName, 0);
					BeanTestUtil.setProperty(blogPosting2, entityFieldName, 1);
				}
...
// LIFERAY-REST-BUILDER-HASH:-1279275711