...
public abstract class BaseWikiPageAttachmentResourceTestCase {
	...
	@Test
	public void testGetWikiPageAttachmentMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {
		...
		String endpoint = StringBundler.concat(
			"/headless-delivery/v1.0/wiki-page-attachments/{wikiPageAttachmentId}".
				replace(
					"{wikiPageAttachmentId}",
					String.valueOf(postWikiPageAttachment.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/wiki-page-attachments/{wikiPageAttachmentId}".
								replace(
									"{wikiPageAttachmentId}",
									String.valueOf(
										postWikiPageAttachment.getId()));
			...
			Assert.assertTrue(
				equals(
					WikiPageAttachmentSerDes.toDTO(apiResponse),
					WikiPageAttachmentSerDes.toDTO(vulcanResponse)));
		}
	}
