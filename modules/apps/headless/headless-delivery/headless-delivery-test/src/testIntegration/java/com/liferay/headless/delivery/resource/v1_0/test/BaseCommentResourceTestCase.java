...
public abstract class BaseCommentResourceTestCase {
	...
	@Test
	public void testGetCommentMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {

		Comment postComment = testGetComment_addComment();

		String endpoint = StringBundler.concat(
			"/headless-delivery/v1.0/comments/{commentId}".replace(
				"{commentId}", String.valueOf(postComment.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/comments/{commentId}".replace(
								"{commentId}",
			...
			Assert.assertTrue(
				equals(
					CommentSerDes.toDTO(apiResponse),
					CommentSerDes.toDTO(vulcanResponse)));
		}
	}
