...
public abstract class BaseDocumentMetadataSetResourceTestCase {
	...
	@Test
	public void testGetDocumentMetadataSetMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {
		...
		String endpoint = StringBundler.concat(
			"/headless-delivery/v1.0/document-metadata-sets/{documentMetadataSetId}".
				replace(
					"{documentMetadataSetId}",
					String.valueOf(postDocumentMetadataSet.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/document-metadata-sets/{documentMetadataSetId}".
								replace(
									"{documentMetadataSetId}",
									String.valueOf(
										postDocumentMetadataSet.getId()));
			...
			Assert.assertTrue(
				equals(
					DocumentMetadataSetSerDes.toDTO(apiResponse),
					DocumentMetadataSetSerDes.toDTO(vulcanResponse)));
		}
	}
