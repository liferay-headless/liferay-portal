...
public abstract class BaseKnowledgeBaseArticleResourceTestCase {
	...
	@Test
	public void testGetKnowledgeBaseArticleMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {
		...
		String endpoint = StringBundler.concat(
			"/headless-delivery/v1.0/knowledge-base-articles/{knowledgeBaseArticleId}".
				replace(
					"{knowledgeBaseArticleId}",
					String.valueOf(postKnowledgeBaseArticle.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/knowledge-base-articles/{knowledgeBaseArticleId}".
								replace(
									"{knowledgeBaseArticleId}",
									String.valueOf(
										postKnowledgeBaseArticle.getId()));
			...
			Assert.assertTrue(
				equals(
					KnowledgeBaseArticleSerDes.toDTO(apiResponse),
					KnowledgeBaseArticleSerDes.toDTO(vulcanResponse)));
		}
	}
