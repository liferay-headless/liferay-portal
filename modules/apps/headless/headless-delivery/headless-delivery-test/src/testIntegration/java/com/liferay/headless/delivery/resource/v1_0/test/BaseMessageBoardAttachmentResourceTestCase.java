...
public abstract class BaseMessageBoardAttachmentResourceTestCase {
	...
	@Test
	public void testGetMessageBoardAttachmentMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {
		...
		String endpoint = StringBundler.concat(
			"/headless-delivery/v1.0/message-board-attachments/{messageBoardAttachmentId}".
				replace(
					"{messageBoardAttachmentId}",
					String.valueOf(postMessageBoardAttachment.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/message-board-attachments/{messageBoardAttachmentId}".
								replace(
									"{messageBoardAttachmentId}",
									String.valueOf(
										postMessageBoardAttachment.getId()));
			...
			Assert.assertTrue(
				equals(
					MessageBoardAttachmentSerDes.toDTO(apiResponse),
					MessageBoardAttachmentSerDes.toDTO(vulcanResponse)));
		}
	}
