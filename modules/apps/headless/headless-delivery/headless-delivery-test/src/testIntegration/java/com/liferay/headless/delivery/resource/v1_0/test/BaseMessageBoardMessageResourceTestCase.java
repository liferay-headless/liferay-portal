...
public abstract class BaseMessageBoardMessageResourceTestCase {
	...
	@Test
	public void testGetMessageBoardMessageMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {
		...
		String endpoint = StringBundler.concat(
			"/headless-delivery/v1.0/message-board-messages/{messageBoardMessageId}".
				replace(
					"{messageBoardMessageId}",
					String.valueOf(postMessageBoardMessage.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/message-board-messages/{messageBoardMessageId}".
								replace(
									"{messageBoardMessageId}",
									String.valueOf(
										postMessageBoardMessage.getId()));
			...
			Assert.assertTrue(
				equals(
					MessageBoardMessageSerDes.toDTO(apiResponse),
					MessageBoardMessageSerDes.toDTO(vulcanResponse)));
		}
	}
