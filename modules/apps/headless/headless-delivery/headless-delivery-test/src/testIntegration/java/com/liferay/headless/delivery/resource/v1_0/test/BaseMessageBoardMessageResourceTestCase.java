...
public abstract class BaseMessageBoardMessageResourceTestCase {
	...
	@Test
	public void testGetMessageBoardMessageMessageBoardMessagesPageWithSortCollection()
		throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				Method method = messageBoardMessage1.getClass(
				).getMethod(
					"get" + StringUtil.upperCaseFirstLetter(entityFieldName)
				);
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(
						messageBoardMessage1, entityFieldName, 0L);
					BeanTestUtil.setProperty(
						messageBoardMessage2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(
						messageBoardMessage1, entityFieldName, 0);
					BeanTestUtil.setProperty(
						messageBoardMessage2, entityFieldName, 1);
				}
	...
	@Test
	public void testGetMessageBoardThreadMessageBoardMessagesPageWithSortCollection()
		throws Exception {
	...
	@Test
	public void testGetSiteMessageBoardMessagesPageWithSortCollection()
		throws Exception {
...
// LIFERAY-REST-BUILDER-HASH:-534599048