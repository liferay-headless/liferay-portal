...
public abstract class BaseKnowledgeBaseFolderResourceTestCase {
	...
	@Test
	public void testGetKnowledgeBaseFolderMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {
		...
		String endpoint = StringBundler.concat(
			"/headless-delivery/v1.0/knowledge-base-folders/{knowledgeBaseFolderId}".
				replace(
					"{knowledgeBaseFolderId}",
					String.valueOf(postKnowledgeBaseFolder.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/knowledge-base-folders/{knowledgeBaseFolderId}".
								replace(
									"{knowledgeBaseFolderId}",
									String.valueOf(
										postKnowledgeBaseFolder.getId()));
			...
			Assert.assertTrue(
				equals(
					KnowledgeBaseFolderSerDes.toDTO(apiResponse),
					KnowledgeBaseFolderSerDes.toDTO(vulcanResponse)));
		}
	}
