...
public abstract class BaseKnowledgeBaseAttachmentResourceTestCase {
	...
	@Test
	public void testGetKnowledgeBaseAttachmentMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {
		...
		String endpoint = StringBundler.concat(
			"/headless-delivery/v1.0/knowledge-base-attachments/{knowledgeBaseAttachmentId}".
				replace(
					"{knowledgeBaseAttachmentId}",
					String.valueOf(postKnowledgeBaseAttachment.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/knowledge-base-attachments/{knowledgeBaseAttachmentId}".
								replace(
									"{knowledgeBaseAttachmentId}",
									String.valueOf(
										postKnowledgeBaseAttachment.getId()));
			...
			Assert.assertTrue(
				equals(
					KnowledgeBaseAttachmentSerDes.toDTO(apiResponse),
					KnowledgeBaseAttachmentSerDes.toDTO(vulcanResponse)));
		}
	}
