...
public abstract class BaseBlogPostingImageResourceTestCase {
	...
	@Test
	public void testGetBlogPostingImageMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {
		...
		String endpoint = StringBundler.concat(
			"/headless-delivery/v1.0/blog-posting-images/{blogPostingImageId}".
				replace(
					"{blogPostingImageId}",
					String.valueOf(postBlogPostingImage.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/blog-posting-images/{blogPostingImageId}".
								replace(
									"{blogPostingImageId}",
									String.valueOf(
										postBlogPostingImage.getId()));
			...
			Assert.assertTrue(
				equals(
					BlogPostingImageSerDes.toDTO(apiResponse),
					BlogPostingImageSerDes.toDTO(vulcanResponse)));
		}
	}
