...
public abstract class BaseDocumentShortcutResourceTestCase {
	...
	@Test
	public void testGetDocumentShortcutMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {
		...
		String endpoint = StringBundler.concat(
			"/headless-delivery/v1.0/document-shortcuts/{documentShortcutId}".
				replace(
					"{documentShortcutId}",
					String.valueOf(postDocumentShortcut.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/document-shortcuts/{documentShortcutId}".
								replace(
									"{documentShortcutId}",
									String.valueOf(
										postDocumentShortcut.getId()));
			...
			Assert.assertTrue(
				equals(
					DocumentShortcutSerDes.toDTO(apiResponse),
					DocumentShortcutSerDes.toDTO(vulcanResponse)));
		}
	}
