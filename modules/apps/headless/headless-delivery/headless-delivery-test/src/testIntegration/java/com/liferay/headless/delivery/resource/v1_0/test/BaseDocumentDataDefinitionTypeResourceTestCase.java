...
public abstract class BaseDocumentDataDefinitionTypeResourceTestCase {
	...
	@Test
	public void testGetDocumentDataDefinitionTypeMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {
		...
		String endpoint = StringBundler.concat(
			"/headless-delivery/v1.0/document-data-definition-types/{documentDataDefinitionTypeId}".
				replace(
					"{documentDataDefinitionTypeId}",
					String.valueOf(postDocumentDataDefinitionType.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/document-data-definition-types/{documentDataDefinitionTypeId}".
								replace(
									"{documentDataDefinitionTypeId}",
									String.valueOf(
										postDocumentDataDefinitionType.
											getId()));
						}
			...
			Assert.assertTrue(
				equals(
					DocumentDataDefinitionTypeSerDes.toDTO(apiResponse),
					DocumentDataDefinitionTypeSerDes.toDTO(vulcanResponse)));
		}
	}
