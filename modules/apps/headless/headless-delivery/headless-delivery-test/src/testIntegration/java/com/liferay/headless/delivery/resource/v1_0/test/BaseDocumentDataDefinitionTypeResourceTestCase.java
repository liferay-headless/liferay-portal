...
public abstract class BaseDocumentDataDefinitionTypeResourceTestCase {
	...
	@Test
	public void testGetAssetLibraryDocumentDataDefinitionTypesPageWithSortCollection()
		throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				Method method = documentDataDefinitionType1.getClass(
				).getMethod(
					"get" + StringUtil.upperCaseFirstLetter(entityFieldName)
				);
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(
						documentDataDefinitionType1, entityFieldName, 0L);
					BeanTestUtil.setProperty(
						documentDataDefinitionType2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(
						documentDataDefinitionType1, entityFieldName, 0);
					BeanTestUtil.setProperty(
						documentDataDefinitionType2, entityFieldName, 1);
				}
	...
	@Test
	public void testGetSiteDocumentDataDefinitionTypesPageWithSortCollection()
		throws Exception {
...
// LIFERAY-REST-BUILDER-HASH:-581645185