...
public abstract class BaseDocumentFolderResourceTestCase {
	...
	@Test
	public void testGetDocumentFolderMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {
		...
		String endpoint = StringBundler.concat(
			"/headless-delivery/v1.0/document-folders/{documentFolderId}".
				replace(
					"{documentFolderId}",
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/document-folders/{documentFolderId}".
								replace(
									"{documentFolderId}",
									String.valueOf(postDocumentFolder.getId()));
						}
			...
			Assert.assertTrue(
				equals(
					DocumentFolderSerDes.toDTO(apiResponse),
					DocumentFolderSerDes.toDTO(vulcanResponse)));
		}
	}
