...
public abstract class BaseStructuredContentResourceTestCase {
	...
	@Test
	public void testGetStructuredContentMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {
		...
		String endpoint = StringBundler.concat(
			"/headless-delivery/v1.0/structured-contents/{structuredContentId}".
				replace(
					"{structuredContentId}",
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/structured-contents/{structuredContentId}".
								replace(
									"{structuredContentId}",
									String.valueOf(
										postStructuredContent.getId()));
			...
			Assert.assertTrue(
				equals(
					StructuredContentSerDes.toDTO(apiResponse),
					StructuredContentSerDes.toDTO(vulcanResponse)));
		}
	}
