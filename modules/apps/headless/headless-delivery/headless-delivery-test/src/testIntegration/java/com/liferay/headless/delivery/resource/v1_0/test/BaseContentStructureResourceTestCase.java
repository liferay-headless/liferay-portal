...
public abstract class BaseContentStructureResourceTestCase {
	...
	@Test
	public void testGetContentStructureMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {
		...
		String endpoint = StringBundler.concat(
			"/headless-delivery/v1.0/content-structures/{contentStructureId}".
				replace(
					"{contentStructureId}",
					String.valueOf(postContentStructure.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/content-structures/{contentStructureId}".
								replace(
									"{contentStructureId}",
									String.valueOf(
										postContentStructure.getId()));
			...
			Assert.assertTrue(
				equals(
					ContentStructureSerDes.toDTO(apiResponse),
					ContentStructureSerDes.toDTO(vulcanResponse)));
		}
	}
