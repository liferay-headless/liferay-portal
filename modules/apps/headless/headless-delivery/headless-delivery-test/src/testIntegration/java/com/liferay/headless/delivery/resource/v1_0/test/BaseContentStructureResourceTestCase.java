...
public abstract class BaseContentStructureResourceTestCase {
	...
	@Test
	public void testGetAssetLibraryContentStructuresPageWithSortCollection()
		throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				Method method = contentStructure1.getClass(
				).getMethod(
					"get" + StringUtil.upperCaseFirstLetter(entityFieldName)
				);
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(
						contentStructure1, entityFieldName, 0L);
					BeanTestUtil.setProperty(
						contentStructure2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(
						contentStructure1, entityFieldName, 0);
					BeanTestUtil.setProperty(
						contentStructure2, entityFieldName, 1);
				}
	...
	@Test
	public void testGetSiteContentStructuresPageWithSortCollection()
		throws Exception {
...
// LIFERAY-REST-BUILDER-HASH:-1613818498