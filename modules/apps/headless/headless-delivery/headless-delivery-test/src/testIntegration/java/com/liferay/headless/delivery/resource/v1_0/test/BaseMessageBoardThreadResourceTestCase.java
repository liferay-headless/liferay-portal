...
public abstract class BaseMessageBoardThreadResourceTestCase {
	...
	@Test
	public void testGetMessageBoardSectionMessageBoardThreadsPageWithSortCollection()
		throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				Method method = messageBoardThread1.getClass(
				).getMethod(
					"get" + StringUtil.upperCaseFirstLetter(entityFieldName)
				);
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(
						messageBoardThread1, entityFieldName, 0L);
					BeanTestUtil.setProperty(
						messageBoardThread2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(
						messageBoardThread1, entityFieldName, 0);
					BeanTestUtil.setProperty(
						messageBoardThread2, entityFieldName, 1);
				}
	...
	@Test
	public void testGetMessageBoardThreadsRankedPageWithSortCollection()
		throws Exception {
	...
	@Test
	public void testGetSiteMessageBoardThreadsPageWithSortCollection()
		throws Exception {
...
// LIFERAY-REST-BUILDER-HASH:-402989809