...
public abstract class BaseMessageBoardThreadResourceTestCase {
	...
	@Test
	public void testGetMessageBoardThreadMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {
		...
		String endpoint = StringBundler.concat(
			"/headless-delivery/v1.0/message-board-threads/{messageBoardThreadId}".
				replace(
					"{messageBoardThreadId}",
					String.valueOf(postMessageBoardThread.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/message-board-threads/{messageBoardThreadId}".
								replace(
									"{messageBoardThreadId}",
									String.valueOf(
										postMessageBoardThread.getId()));
			...
			Assert.assertTrue(
				equals(
					MessageBoardThreadSerDes.toDTO(apiResponse),
					MessageBoardThreadSerDes.toDTO(vulcanResponse)));
		}
	}
