...
import com.liferay.headless.delivery.dto.v1_0.Metadata;
...
public class DocumentDTOConverter
		...
		return new DocumentType() {
			{
				...
				metadata = TransformUtil.transformToArray(
					dlFileEntryType.getDDMStructures(),
					ddmStructure -> _toMetadata(
						ddmStructure, dlFileVersion, dtoConverterContext),
					Metadata.class);
	...
	private Metadata _toMetadata(
			DDMStructure ddmStructure, DLFileVersion dlFileVersion,
		...
		return new Metadata() {
			{
				contentFields = TransformUtil.transformToArray(
					ddmFormValues.getDDMFormFieldValues(),
					ddmFormFieldValue -> ContentFieldUtil.toContentField(
						ddmFormFieldValue, _dlAppService, _dlURLHelper,
						dtoConverterContext, _journalArticleService,
						_layoutLocalService),
					ContentField.class);
				name = ddmStructure.getName(dtoConverterContext.getLocale());
				name_i18n = LocalizedMapUtil.getI18nMap(
					dtoConverterContext.isAcceptAllLanguages(),
