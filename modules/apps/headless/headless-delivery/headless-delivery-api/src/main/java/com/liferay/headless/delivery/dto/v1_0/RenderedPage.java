...
public class RenderedPage implements Serializable {
	...
	public String getRenderedPageValue() {
		return renderedPageValue;
	}

	public void setRenderedPageValue(String renderedPageValue) {
		this.renderedPageValue = renderedPageValue;
	}

	@JsonIgnore
	public void setRenderedPageValue(
		UnsafeSupplier<String, Exception> renderedPageValueUnsafeSupplier) {

		try {
			renderedPageValue = renderedPageValueUnsafeSupplier.get();
		}
		catch (RuntimeException re) {
			throw re;
		}
	...
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	protected String renderedPageValue;
	...
	public String toString() {
		...
		if (renderedPageValue != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}

			sb.append("\"renderedPageValue\": ");

			sb.append("\"");

			sb.append(_escape(renderedPageValue));
