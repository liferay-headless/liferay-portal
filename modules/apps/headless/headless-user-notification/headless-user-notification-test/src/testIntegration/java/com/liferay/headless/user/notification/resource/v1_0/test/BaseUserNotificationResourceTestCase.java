...
public abstract class BaseUserNotificationResourceTestCase {
	...
	@Test
	public void testGetUserNotificationMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {
		...
		String endpoint = StringBundler.concat(
			"/headless-user-notification/v1.0/user-notifications/{userNotificationId}".
				replace(
					"{userNotificationId}",
					String.valueOf(postUserNotification.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/user-notifications/{userNotificationId}".
								replace(
									"{userNotificationId}",
									String.valueOf(
										postUserNotification.getId()));
			...
			Assert.assertTrue(
				equals(
					UserNotificationSerDes.toDTO(apiResponse),
					UserNotificationSerDes.toDTO(vulcanResponse)));
		}
	}
