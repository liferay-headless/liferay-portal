...
public abstract class BaseCountryResourceTestCase {
	...
	@Test
	public void testGetCountriesPageWithSortCollection() throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				Method method = country1.getClass(
				).getMethod(
					"get" + StringUtil.upperCaseFirstLetter(entityFieldName)
				);
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(country1, entityFieldName, 0L);
					BeanTestUtil.setProperty(country2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(country1, entityFieldName, 0);
					BeanTestUtil.setProperty(country2, entityFieldName, 1);
				}
...
// LIFERAY-REST-BUILDER-HASH:-1609998876