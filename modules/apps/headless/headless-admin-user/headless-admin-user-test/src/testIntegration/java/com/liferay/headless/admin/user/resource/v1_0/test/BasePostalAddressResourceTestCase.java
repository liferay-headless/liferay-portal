...
public abstract class BasePostalAddressResourceTestCase {
	...
	@Test
	public void testGetPostalAddressMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {
		...
		String endpoint = StringBundler.concat(
			"/headless-admin-user/v1.0/postal-addresses/{postalAddressId}".
				replace(
					"{postalAddressId}",
					String.valueOf(postPostalAddress.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/postal-addresses/{postalAddressId}".
								replace(
									"{postalAddressId}",
									String.valueOf(postPostalAddress.getId()));
						}
			...
			Assert.assertTrue(
				equals(
					PostalAddressSerDes.toDTO(apiResponse),
					PostalAddressSerDes.toDTO(vulcanResponse)));
		}
	}
