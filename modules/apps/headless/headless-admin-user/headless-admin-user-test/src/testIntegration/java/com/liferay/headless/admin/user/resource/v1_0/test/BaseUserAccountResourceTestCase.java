...
public abstract class BaseUserAccountResourceTestCase {
	...
	@Test
	public void testGetUserAccountMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {

		UserAccount postUserAccount = testGetUserAccount_addUserAccount();

		String endpoint = StringBundler.concat(
			"/headless-admin-user/v1.0/user-accounts/{userAccountId}".replace(
				"{userAccountId}", String.valueOf(postUserAccount.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/user-accounts/{userAccountId}".replace(
								"{userAccountId}",
								String.valueOf(postUserAccount.getId()));
						}
			...
			Assert.assertTrue(
				equals(
					UserAccountSerDes.toDTO(apiResponse),
					UserAccountSerDes.toDTO(vulcanResponse)));
		}
	}
