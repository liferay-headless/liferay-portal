...
public abstract class BaseAccountGroupResourceTestCase {
	...
	@Test
	public void testGetAccountGroupMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {

		AccountGroup postAccountGroup = testGetAccountGroup_addAccountGroup();

		String endpoint = StringBundler.concat(
			"/headless-admin-user/v1.0/account-groups/{accountGroupId}".replace(
				"{accountGroupId}", String.valueOf(postAccountGroup.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/account-groups/{accountGroupId}".
								replace(
									"{accountGroupId}",
									String.valueOf(postAccountGroup.getId()));
						}
			...
			Assert.assertTrue(
				equals(
					AccountGroupSerDes.toDTO(apiResponse),
					AccountGroupSerDes.toDTO(vulcanResponse)));
		}
	}
