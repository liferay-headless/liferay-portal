...
public abstract class BaseAccountGroupResourceTestCase {
	...
	public void testGetAccountGroupsPageWithSortCollection() throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				Method method = accountGroup1.getClass(
				).getMethod(
					"get" + StringUtil.upperCaseFirstLetter(entityFieldName)
				);
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(
						accountGroup1, entityFieldName, 0L);
					BeanTestUtil.setProperty(
						accountGroup2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(accountGroup1, entityFieldName, 0);
					BeanTestUtil.setProperty(accountGroup2, entityFieldName, 1);
				}
...
// LIFERAY-REST-BUILDER-HASH:-87420218