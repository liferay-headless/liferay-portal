...
public abstract class BaseFormDocumentResourceTestCase {
	...
	@Test
	public void testGetFormDocumentMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {

		FormDocument postFormDocument = testGetFormDocument_addFormDocument();

		String endpoint = StringBundler.concat(
			"/headless-form/v1.0/form-documents/{formDocumentId}".replace(
				"{formDocumentId}", String.valueOf(postFormDocument.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/form-documents/{formDocumentId}".
								replace(
									"{formDocumentId}",
									String.valueOf(postFormDocument.getId()));
						}
			...
			Assert.assertTrue(
				equals(
					FormDocumentSerDes.toDTO(apiResponse),
					FormDocumentSerDes.toDTO(vulcanResponse)));
		}
	}
