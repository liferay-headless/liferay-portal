...
public abstract class BaseFormStructureResourceTestCase {
	...
	@Test
	public void testGetFormStructureMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {
		...
		String endpoint = StringBundler.concat(
			"/headless-form/v1.0/form-structures/{formStructureId}".replace(
				"{formStructureId}",
				String.valueOf(postFormStructure.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/form-structures/{formStructureId}".
								replace(
									"{formStructureId}",
									String.valueOf(postFormStructure.getId()));
						}
			...
			Assert.assertTrue(
				equals(
					FormStructureSerDes.toDTO(apiResponse),
					FormStructureSerDes.toDTO(vulcanResponse)));
		}
	}
