...
public abstract class BasePageTemplateResourceTestCase {
	...
	@Test
	public void testGetSitePageTemplatesPageWithSortCollection()
		throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				Method method = pageTemplate1.getClass(
				).getMethod(
					"get" + StringUtil.upperCaseFirstLetter(entityFieldName)
				);
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(
						pageTemplate1, entityFieldName, 0L);
					BeanTestUtil.setProperty(
						pageTemplate2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(pageTemplate1, entityFieldName, 0);
					BeanTestUtil.setProperty(pageTemplate2, entityFieldName, 1);
				}
...
// LIFERAY-REST-BUILDER-HASH:2129067369