...
public abstract class BaseUtilityPageResourceTestCase {
	...
	@Test
	public void testGetSiteUtilityPagesPageWithSortCollection()
		throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				Method method = utilityPage1.getClass(
				).getMethod(
					"get" + StringUtil.upperCaseFirstLetter(entityFieldName)
				);
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(utilityPage1, entityFieldName, 0L);
					BeanTestUtil.setProperty(utilityPage2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(utilityPage1, entityFieldName, 0);
					BeanTestUtil.setProperty(utilityPage2, entityFieldName, 1);
				}
...
// LIFERAY-REST-BUILDER-HASH:-588659977