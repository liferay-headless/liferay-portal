...
public abstract class BaseMasterPageResourceTestCase {
	...
	@Test
	public void testGetSiteMasterPagesPageWithSortCollection()
		throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				Method method = masterPage1.getClass(
				).getMethod(
					"get" + StringUtil.upperCaseFirstLetter(entityFieldName)
				);
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(masterPage1, entityFieldName, 0L);
					BeanTestUtil.setProperty(masterPage2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(masterPage1, entityFieldName, 0);
					BeanTestUtil.setProperty(masterPage2, entityFieldName, 1);
				}
...
// LIFERAY-REST-BUILDER-HASH:-2071118971