...
public abstract class BaseWorkflowInstanceResourceTestCase {
	...
	@Test
	public void testGetWorkflowInstanceMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {
		...
		String endpoint = StringBundler.concat(
			"/headless-admin-workflow/v1.0/workflow-instances/{workflowInstanceId}".
				replace(
					"{workflowInstanceId}",
					String.valueOf(postWorkflowInstance.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/workflow-instances/{workflowInstanceId}".
								replace(
									"{workflowInstanceId}",
									String.valueOf(
										postWorkflowInstance.getId()));
			...
			Assert.assertTrue(
				equals(
					WorkflowInstanceSerDes.toDTO(apiResponse),
					WorkflowInstanceSerDes.toDTO(vulcanResponse)));
		}
	}
