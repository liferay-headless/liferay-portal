...
public abstract class BaseWorkflowDefinitionResourceTestCase {
	...
	@Test
	public void testGetWorkflowDefinitionMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {
		...
		String endpoint = StringBundler.concat(
			"/headless-admin-workflow/v1.0/workflow-definitions/{workflowDefinitionId}".
				replace(
					"{workflowDefinitionId}",
					String.valueOf(postWorkflowDefinition.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/workflow-definitions/{workflowDefinitionId}".
								replace(
									"{workflowDefinitionId}",
									String.valueOf(
										postWorkflowDefinition.getId()));
			...
			Assert.assertTrue(
				equals(
					WorkflowDefinitionSerDes.toDTO(apiResponse),
					WorkflowDefinitionSerDes.toDTO(vulcanResponse)));
		}
	}
