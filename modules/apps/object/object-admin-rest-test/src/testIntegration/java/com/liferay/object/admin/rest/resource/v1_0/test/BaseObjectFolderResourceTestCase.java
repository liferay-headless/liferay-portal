...
public abstract class BaseObjectFolderResourceTestCase {
	...
	@Test
	public void testGetObjectFolderMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {

		ObjectFolder postObjectFolder = testGetObjectFolder_addObjectFolder();

		String endpoint = StringBundler.concat(
			"/object-admin/v1.0/object-folders/{objectFolderId}".replace(
				"{objectFolderId}", String.valueOf(postObjectFolder.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/object-folders/{objectFolderId}".
								replace(
									"{objectFolderId}",
									String.valueOf(postObjectFolder.getId()));
						}
			...
			Assert.assertTrue(
				equals(
					ObjectFolderSerDes.toDTO(apiResponse),
					ObjectFolderSerDes.toDTO(vulcanResponse)));
		}
	}
