...
public abstract class BaseObjectDefinitionResourceTestCase {
	...
	@Test
	public void testGetObjectDefinitionMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {
		...
		String endpoint = StringBundler.concat(
			"/object-admin/v1.0/object-definitions/{objectDefinitionId}".
				replace(
					"{objectDefinitionId}",
					String.valueOf(postObjectDefinition.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/object-definitions/{objectDefinitionId}".
								replace(
									"{objectDefinitionId}",
									String.valueOf(
										postObjectDefinition.getId()));
			...
			Assert.assertTrue(
				equals(
					ObjectDefinitionSerDes.toDTO(apiResponse),
					ObjectDefinitionSerDes.toDTO(vulcanResponse)));
		}
	}
