...
public abstract class BaseObjectActionResourceTestCase {
	...
	@Test
	public void testGetObjectActionMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {

		ObjectAction postObjectAction = testGetObjectAction_addObjectAction();

		String endpoint = StringBundler.concat(
			"/object-admin/v1.0/object-actions/{objectActionId}".replace(
				"{objectActionId}", String.valueOf(postObjectAction.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/object-actions/{objectActionId}".
								replace(
									"{objectActionId}",
									String.valueOf(postObjectAction.getId()));
						}
			...
			Assert.assertTrue(
				equals(
					ObjectActionSerDes.toDTO(apiResponse),
					ObjectActionSerDes.toDTO(vulcanResponse)));
		}
	}
