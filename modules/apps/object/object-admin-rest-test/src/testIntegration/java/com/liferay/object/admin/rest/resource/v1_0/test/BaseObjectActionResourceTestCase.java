...
public abstract class BaseObjectActionResourceTestCase {
	...
	@Test
	public void testGetObjectDefinitionByExternalReferenceCodeObjectActionsPageWithSortCollection()
		throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				Method method = objectAction1.getClass(
				).getMethod(
					"get" + StringUtil.upperCaseFirstLetter(entityFieldName)
				);
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(
						objectAction1, entityFieldName, 0L);
					BeanTestUtil.setProperty(
						objectAction2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(objectAction1, entityFieldName, 0);
					BeanTestUtil.setProperty(objectAction2, entityFieldName, 1);
				}
	...
	@Test
	public void testGetObjectDefinitionObjectActionsPageWithSortCollection()
		throws Exception {
...
// LIFERAY-REST-BUILDER-HASH:553061698