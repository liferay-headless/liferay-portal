...
public abstract class BaseObjectRelationshipResourceTestCase {
	...
	@Test
	public void testGetObjectRelationshipMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {
		...
		String endpoint = StringBundler.concat(
			"/object-admin/v1.0/object-relationships/{objectRelationshipId}".
				replace(
					"{objectRelationshipId}",
					String.valueOf(postObjectRelationship.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/object-relationships/{objectRelationshipId}".
								replace(
									"{objectRelationshipId}",
									String.valueOf(
										postObjectRelationship.getId()));
			...
			Assert.assertTrue(
				equals(
					ObjectRelationshipSerDes.toDTO(apiResponse),
					ObjectRelationshipSerDes.toDTO(vulcanResponse)));
		}
	}
