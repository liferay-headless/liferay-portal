...
public abstract class BaseObjectViewResourceTestCase {
	...
	@Test
	public void testGetObjectDefinitionByExternalReferenceCodeObjectViewsPageWithSortCollection()
		throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				Method method = objectView1.getClass(
				).getMethod(
					"get" + StringUtil.upperCaseFirstLetter(entityFieldName)
				);
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(objectView1, entityFieldName, 0L);
					BeanTestUtil.setProperty(objectView2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(objectView1, entityFieldName, 0);
					BeanTestUtil.setProperty(objectView2, entityFieldName, 1);
				}
	...
	@Test
	public void testGetObjectDefinitionObjectViewsPageWithSortCollection()
		throws Exception {
...
// LIFERAY-REST-BUILDER-HASH:613745562