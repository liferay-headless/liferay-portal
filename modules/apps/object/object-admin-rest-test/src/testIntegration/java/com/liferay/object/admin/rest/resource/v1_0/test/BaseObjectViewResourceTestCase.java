...
public abstract class BaseObjectViewResourceTestCase {
	...
	@Test
	public void testGetObjectViewMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {

		ObjectView postObjectView = testGetObjectView_addObjectView();

		String endpoint = StringBundler.concat(
			"/object-admin/v1.0/object-views/{objectViewId}".replace(
				"{objectViewId}", String.valueOf(postObjectView.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/object-views/{objectViewId}".replace(
								"{objectViewId}",
								String.valueOf(postObjectView.getId()));
						}
			...
			Assert.assertTrue(
				equals(
					ObjectViewSerDes.toDTO(apiResponse),
					ObjectViewSerDes.toDTO(vulcanResponse)));
		}
	}
