...
public abstract class BaseObjectValidationRuleResourceTestCase {
	...
	@Test
	public void testGetObjectValidationRuleMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {
		...
		String endpoint = StringBundler.concat(
			"/object-admin/v1.0/object-validation-rules/{objectValidationRuleId}".
				replace(
					"{objectValidationRuleId}",
					String.valueOf(postObjectValidationRule.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/object-validation-rules/{objectValidationRuleId}".
								replace(
									"{objectValidationRuleId}",
									String.valueOf(
										postObjectValidationRule.getId()));
			...
			Assert.assertTrue(
				equals(
					ObjectValidationRuleSerDes.toDTO(apiResponse),
					ObjectValidationRuleSerDes.toDTO(vulcanResponse)));
		}
	}
