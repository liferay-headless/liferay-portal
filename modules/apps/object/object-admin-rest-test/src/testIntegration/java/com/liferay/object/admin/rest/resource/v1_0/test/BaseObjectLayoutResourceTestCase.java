...
public abstract class BaseObjectLayoutResourceTestCase {
	...
	@Test
	public void testGetObjectDefinitionByExternalReferenceCodeObjectLayoutsPageWithSortCollection()
		throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				Method method = objectLayout1.getClass(
				).getMethod(
					"get" + StringUtil.upperCaseFirstLetter(entityFieldName)
				);
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(
						objectLayout1, entityFieldName, 0L);
					BeanTestUtil.setProperty(
						objectLayout2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(objectLayout1, entityFieldName, 0);
					BeanTestUtil.setProperty(objectLayout2, entityFieldName, 1);
				}
	...
	@Test
	public void testGetObjectDefinitionObjectLayoutsPageWithSortCollection()
		throws Exception {
...
// LIFERAY-REST-BUILDER-HASH:808676501