...
public abstract class BaseObjectLayoutResourceTestCase {
	...
	@Test
	public void testGetObjectLayoutMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {

		ObjectLayout postObjectLayout = testGetObjectLayout_addObjectLayout();

		String endpoint = StringBundler.concat(
			"/object-admin/v1.0/object-layouts/{objectLayoutId}".replace(
				"{objectLayoutId}", String.valueOf(postObjectLayout.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/object-layouts/{objectLayoutId}".
								replace(
									"{objectLayoutId}",
									String.valueOf(postObjectLayout.getId()));
						}
			...
			Assert.assertTrue(
				equals(
					ObjectLayoutSerDes.toDTO(apiResponse),
					ObjectLayoutSerDes.toDTO(vulcanResponse)));
		}
	}
