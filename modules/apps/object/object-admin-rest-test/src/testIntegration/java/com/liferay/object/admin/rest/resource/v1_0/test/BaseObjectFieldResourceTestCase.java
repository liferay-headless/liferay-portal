...
public abstract class BaseObjectFieldResourceTestCase {
	...
	@Test
	public void testGetObjectDefinitionByExternalReferenceCodeObjectFieldsPageWithSortCollection()
		throws Exception {
		...
		for (EntityField entityField :
			...
			try {
				Method method = objectField1.getClass(
				).getMethod(
					"get" + StringUtil.upperCaseFirstLetter(entityFieldName)
				);
				...
				if (returnType.equals(Long.class)) {
					BeanTestUtil.setProperty(objectField1, entityFieldName, 0L);
					BeanTestUtil.setProperty(objectField2, entityFieldName, 1L);
				}
				else if (returnType.equals(Integer.class)) {
					BeanTestUtil.setProperty(objectField1, entityFieldName, 0);
					BeanTestUtil.setProperty(objectField2, entityFieldName, 1);
				}
	...
	@Test
	public void testGetObjectDefinitionObjectFieldsPageWithSortCollection()
		throws Exception {
...
// LIFERAY-REST-BUILDER-HASH:-474080526