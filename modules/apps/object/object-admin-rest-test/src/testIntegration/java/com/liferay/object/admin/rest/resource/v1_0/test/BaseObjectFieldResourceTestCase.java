...
public abstract class BaseObjectFieldResourceTestCase {
	...
	@Test
	public void testGetObjectFieldMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {

		ObjectField postObjectField = testGetObjectField_addObjectField();

		String endpoint = StringBundler.concat(
			"/object-admin/v1.0/object-fields/{objectFieldId}".replace(
				"{objectFieldId}", String.valueOf(postObjectField.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/object-fields/{objectFieldId}".replace(
								"{objectFieldId}",
								String.valueOf(postObjectField.getId()));
						}
			...
			Assert.assertTrue(
				equals(
					ObjectFieldSerDes.toDTO(apiResponse),
					ObjectFieldSerDes.toDTO(vulcanResponse)));
		}
	}
