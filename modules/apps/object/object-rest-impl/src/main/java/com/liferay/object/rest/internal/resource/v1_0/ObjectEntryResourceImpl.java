...
public class ObjectEntryResourceImpl extends BaseObjectEntryResourceImpl {
	...
	public Response deleteObjectEntryBatch(
		...
		return super.deleteObjectEntryBatch(callbackURL, contentString);
	}
	...
	public Response postObjectEntryBatch(
		...
		return super.postObjectEntryBatch(callbackURL, contentString);
	}
	...
	public Response putObjectEntryBatch(
		...
		return super.putObjectEntryBatch(callbackURL, contentString);
	}
