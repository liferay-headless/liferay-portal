...
public class ErcSiteTestEntitySerDes {
	...
	public static String toJSON(ErcSiteTestEntity ercSiteTestEntity) {
		...
		if (ercSiteTestEntity.getSiteId() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			sb.append(ercSiteTestEntity.getSiteId());
		}
	...
	public static Map<String, String> toMap(
		...
		if (ercSiteTestEntity.getSiteId() == null) {
			...
			map.put("siteId", String.valueOf(ercSiteTestEntity.getSiteId()));
		}
