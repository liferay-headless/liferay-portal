...
public class ErcAssetLibraryTestEntitySerDes {
	...
	public static String toJSON(
		...
		if (ercAssetLibraryTestEntity.getAssetLibraryId() != null) {
			...
			sb.append(ercAssetLibraryTestEntity.getAssetLibraryId());
		}
	...
	public static Map<String, String> toMap(
		...
		if (ercAssetLibraryTestEntity.getAssetLibraryId() == null) {
			...
			map.put(
				"assetLibraryId",
				String.valueOf(ercAssetLibraryTestEntity.getAssetLibraryId()));
		}
	...
	public static class ErcAssetLibraryTestEntityJSONParser
		...
		protected void setField(
			...
			if (Objects.equals(
				...
				if (jsonParserFieldValue != null) {
					ercAssetLibraryTestEntity.setAssetLibraryId(
