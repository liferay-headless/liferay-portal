...
public interface ErcSiteTestEntityResource {
	...
	public ErcSiteTestEntity getSiteErcSiteTestEntityByExternalReferenceCode(
			String ercSiteTestEntityExternalReferenceCode,
			String siteExternalReferenceCode)
		throws Exception;

	public HttpInvoker.HttpResponse
			getSiteErcSiteTestEntityByExternalReferenceCodeHttpResponse(
				String ercSiteTestEntityExternalReferenceCode,
				String siteExternalReferenceCode)
		throws Exception;

	public ErcSiteTestEntity putSiteErcSiteTestEntityByExternalReferenceCode(
			String ercSiteTestEntityExternalReferenceCode,
			String siteExternalReferenceCode,
			ErcSiteTestEntity ercSiteTestEntity)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			putSiteErcSiteTestEntityByExternalReferenceCodeHttpResponse(
				String ercSiteTestEntityExternalReferenceCode,
				String siteExternalReferenceCode,
				ErcSiteTestEntity ercSiteTestEntity)
		throws Exception;
	...
	public static class ErcSiteTestEntityResourceImpl
		...
		public ErcSiteTestEntity
				getSiteErcSiteTestEntityByExternalReferenceCode(
					String ercSiteTestEntityExternalReferenceCode,
					String siteExternalReferenceCode)
			throws Exception {
		...
		public ErcSiteTestEntity
				putSiteErcSiteTestEntityByExternalReferenceCode(
					String ercSiteTestEntityExternalReferenceCode,
					String siteExternalReferenceCode,
					ErcSiteTestEntity ercSiteTestEntity)
			throws Exception {
