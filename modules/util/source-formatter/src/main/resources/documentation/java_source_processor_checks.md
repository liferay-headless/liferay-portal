...
[JavaArquillianStaticInitializerCheck](check/java_arquillian_static_initializer_check.md#javaarquillianstaticinitializercheck) | [Bug Prevention](bug_prevention_checks.md#bug-prevention-checks) | Checks that static initializers of Arquillian tests do not call portal test utilities and service methods. |
