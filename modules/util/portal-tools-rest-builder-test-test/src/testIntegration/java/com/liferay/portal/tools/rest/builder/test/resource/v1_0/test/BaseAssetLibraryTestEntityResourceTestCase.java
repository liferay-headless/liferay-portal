...
public abstract class BaseAssetLibraryTestEntityResourceTestCase {
	...
	@Test
	public void testDeleteAssetLibraryAssetLibraryTestEntityByExternalReferenceCodeAssetLibraryTestEntityExternalReferenceCode()
		throws Exception {

		@SuppressWarnings("PMD.UnusedLocalVariable")
		AssetLibraryTestEntity assetLibraryTestEntity =
			testDeleteAssetLibraryAssetLibraryTestEntityByExternalReferenceCodeAssetLibraryTestEntityExternalReferenceCode_addAssetLibraryTestEntity();

		assertHttpResponseStatusCode(
			204,
			assetLibraryTestEntityResource.
				deleteAssetLibraryAssetLibraryTestEntityByExternalReferenceCodeAssetLibraryTestEntityExternalReferenceCodeHttpResponse(
