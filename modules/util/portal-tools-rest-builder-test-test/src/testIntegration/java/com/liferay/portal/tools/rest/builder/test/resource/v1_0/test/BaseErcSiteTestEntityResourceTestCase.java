...
public abstract class BaseErcSiteTestEntityResourceTestCase {
	...
	@Test
	public void testGetSiteByExternalReferenceCodeErcSiteTestEntitiesPage()
		throws Exception {

		String siteExternalReferenceCode =
			testGetSiteByExternalReferenceCodeErcSiteTestEntitiesPage_getSiteExternalReferenceCode();
		String irrelevantSiteExternalReferenceCode =
			testGetSiteByExternalReferenceCodeErcSiteTestEntitiesPage_getIrrelevantSiteExternalReferenceCode();

		Page<ErcSiteTestEntity> page =
			ercSiteTestEntityResource.
				getSiteByExternalReferenceCodeErcSiteTestEntitiesPage(
		...
		if (irrelevantSiteExternalReferenceCode != null) {
			ErcSiteTestEntity irrelevantErcSiteTestEntity =
				testGetSiteByExternalReferenceCodeErcSiteTestEntitiesPage_addErcSiteTestEntity(
			...
			assertValid(
				page,
				testGetSiteByExternalReferenceCodeErcSiteTestEntitiesPage_getExpectedActions(
					irrelevantSiteExternalReferenceCode));
		}
	...
	@Test
	public void testPostSiteByExternalReferenceCodeErcSiteTestEntity()
		throws Exception {

		ErcSiteTestEntity randomErcSiteTestEntity = randomErcSiteTestEntity();

		ErcSiteTestEntity postErcSiteTestEntity =
			testPostSiteByExternalReferenceCodeErcSiteTestEntity_addErcSiteTestEntity(
	...
	@Test
	public void testGetSiteByExternalReferenceCodeErcSiteTestEntityByExternalReferenceCode()
		throws Exception {
	...
	@Test
	public void testPutSiteByExternalReferenceCodeErcSiteTestEntityByExternalReferenceCode()
		throws Exception {
	...
	protected ErcSiteTestEntity
			testPutSiteByExternalReferenceCodeErcSiteTestEntityByExternalReferenceCode_createErcSiteTestEntity()
		throws Exception {
	...
	public void testGetSiteErcSiteTestEntitiesPage() throws Exception {
		Long siteId = testGetSiteErcSiteTestEntitiesPage_getSiteId();
		Long irrelevantSiteId =
			testGetSiteErcSiteTestEntitiesPage_getIrrelevantSiteId();

		Page<ErcSiteTestEntity> page =
			ercSiteTestEntityResource.getSiteErcSiteTestEntitiesPage(siteId);
		...
		if (irrelevantSiteId != null) {
			ErcSiteTestEntity irrelevantErcSiteTestEntity =
				testGetSiteErcSiteTestEntitiesPage_addErcSiteTestEntity(
					irrelevantSiteId, randomIrrelevantErcSiteTestEntity());
		...
		ErcSiteTestEntity ercSiteTestEntity1 =
			testGetSiteErcSiteTestEntitiesPage_addErcSiteTestEntity(
				siteId, randomErcSiteTestEntity());

		ErcSiteTestEntity ercSiteTestEntity2 =
			testGetSiteErcSiteTestEntitiesPage_addErcSiteTestEntity(
				siteId, randomErcSiteTestEntity());

		page = ercSiteTestEntityResource.getSiteErcSiteTestEntitiesPage(siteId);
		...
		assertValid(
			page,
			testGetSiteErcSiteTestEntitiesPage_getExpectedActions(siteId));
	}

	protected Map<String, Map<String, String>>
			testGetSiteErcSiteTestEntitiesPage_getExpectedActions(Long siteId)
		throws Exception {
		...
		createBatchAction.put(
			"href",
			"http://localhost:8080/o/test/v1.0/sites/{siteId}/erc-site-test-entities/batch".
	...
	protected ErcSiteTestEntity
			testGetSiteErcSiteTestEntitiesPage_addErcSiteTestEntity(
				Long siteId, ErcSiteTestEntity ercSiteTestEntity)
		throws Exception {

		return ercSiteTestEntityResource.postSiteErcSiteTestEntity(
			siteId, ercSiteTestEntity);
	}

	protected Long testGetSiteErcSiteTestEntitiesPage_getSiteId()
		throws Exception {

		return testGroup.getGroupId();
	}

	protected Long testGetSiteErcSiteTestEntitiesPage_getIrrelevantSiteId()
		throws Exception {
	...
	protected ErcSiteTestEntity
		...
		return ercSiteTestEntityResource.postSiteErcSiteTestEntity(
			testGetSiteErcSiteTestEntitiesPage_getSiteId(), ercSiteTestEntity);
	}
	...
	protected void assertValid(ErcSiteTestEntity ercSiteTestEntity)
		...
		if (!Objects.equals(
				ercSiteTestEntity.getSiteId(), testGroup.getGroupId())) {
	...
	protected boolean equals(
		...
		if (!Objects.equals(
				ercSiteTestEntity1.getSiteId(),
				ercSiteTestEntity2.getSiteId())) {
	...
	protected ErcSiteTestEntity randomIrrelevantErcSiteTestEntity()
		...
		randomIrrelevantErcSiteTestEntity.setSiteId(
