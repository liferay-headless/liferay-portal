...
public abstract class BaseCompanyTestEntityResourceTestCase {
	...
	@Test
	public void testGetCompanyTestEntityMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {
		...
		String endpoint = StringBundler.concat(
			"/test/v1.0/company-test-entities/{companyTestEntityId}".replace(
				"{companyTestEntityId}",
				String.valueOf(postCompanyTestEntity.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/company-test-entities/{companyTestEntityId}".
								replace(
									"{companyTestEntityId}",
									String.valueOf(
										postCompanyTestEntity.getId()));
			...
			Assert.assertTrue(
				equals(
					CompanyTestEntitySerDes.toDTO(apiResponse),
					CompanyTestEntitySerDes.toDTO(vulcanResponse)));
		}
	}
