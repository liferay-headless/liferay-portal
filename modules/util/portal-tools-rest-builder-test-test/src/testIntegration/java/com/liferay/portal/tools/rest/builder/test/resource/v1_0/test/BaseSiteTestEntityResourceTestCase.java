...
public abstract class BaseSiteTestEntityResourceTestCase {
	...
	@Test
	public void testGetSiteTestEntityMatchesVulcanCRUDItemDelegateGetItem()
		throws Exception {
		...
		String endpoint = StringBundler.concat(
			"/test/v1.0/site-test-entities/{siteTestEntityId}".replace(
				"{siteTestEntityId}",
				String.valueOf(postSiteTestEntity.getId())));
		...
		if (vulcanCRUDItemDelegateBuilder != null) {
				...
				vulcanCRUDItemDelegateBuilder.acceptLanguage(
					...
					new UriInfo() {
						...
						public String getPath() {
							return "v1.0/site-test-entities/{siteTestEntityId}".
								replace(
									"{siteTestEntityId}",
									String.valueOf(postSiteTestEntity.getId()));
						}
			...
			Assert.assertTrue(
				equals(
					SiteTestEntitySerDes.toDTO(apiResponse),
					SiteTestEntitySerDes.toDTO(vulcanResponse)));
		}
	}
