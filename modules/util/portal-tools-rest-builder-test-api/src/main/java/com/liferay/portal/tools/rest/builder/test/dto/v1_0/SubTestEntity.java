 ...
 */
@Generated("")
@GraphQLName("SubTestEntity")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "SubTestEntity")
public class SubTestEntity implements Serializable {

	public static SubTestEntity toDTO(String json) {
		return ObjectMapperUtil.readValue(SubTestEntity.class, json);
	}

	public static SubTestEntity unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(SubTestEntity.class, json);
	}
	...
	public String getErcSiteTestEntityExternalReferenceCode() {
		if (_ercSiteTestEntityExternalReferenceCodeSupplier != null) {
			ercSiteTestEntityExternalReferenceCode =
				_ercSiteTestEntityExternalReferenceCodeSupplier.get();

			_ercSiteTestEntityExternalReferenceCodeSupplier = null;
		}
	...
	public void setErcSiteTestEntityExternalReferenceCode(
		...
		_ercSiteTestEntityExternalReferenceCodeSupplier = () -> {
			try {
				return ercSiteTestEntityExternalReferenceCodeUnsafeSupplier.
					get();
			}
			catch (RuntimeException runtimeException) {
				throw runtimeException;
	...
	@JsonIgnore
	private Supplier<String> _ercSiteTestEntityExternalReferenceCodeSupplier;
	...
	public String toString() {
		...
		if (ercSiteTestEntityExternalReferenceCode != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			sb.append(_escape(ercSiteTestEntityExternalReferenceCode));
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.portal.tools.rest.builder.test.dto.v1_0.SubTestEntity",
		name = "x-class-name"
	)
